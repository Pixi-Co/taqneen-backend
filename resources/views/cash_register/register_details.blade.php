<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h3 class="modal-title">@trans( 'cash_register.register_details' ) ( {{ \Carbon::createFromFormat('Y-m-d H:i:s', $register_details->open_time)->format('jS M, Y h:i A') }} -  {{\Carbon::createFromFormat('Y-m-d H:i:s', $close_time)->format('jS M, Y h:i A')}} )</h3>
    </div>
            ...
            <tr class="success">
              ...
              <td>
                ...
                @if($register_details->total_advance_refund != 0)
                  @trans('lang_v1.advance'): <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_advance_refund }}</span><br>
                @endif
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-default no-print" 
        data-dismiss="modal">@trans( 'messages.cancel' )
      </button>
    </div>
