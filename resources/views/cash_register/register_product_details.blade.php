<div class="row">
  <div class="col-md-12">
    <hr>
    <h3>@trans('lang_v1.product_sold_details_register')</h3>
    <table class="table">
      <tr>
        <th>#</th>
        <th>@trans('brand.brands')</th>
...
@if($details['types_of_service_details'])
  <div class="row">
    <div class="col-md-12">
      <hr>
      <h3>@trans('lang_v1.types_of_service_details')</h3>
      <table class="table">
        <tr>
          <th>#</th>
