...
<section class="content-header">
    <h1>@trans( 'cash_register.cash_register' )
        <small>@trans( 'cash_register.manage_your_cash_register' )</small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
	...
	<div class="box">
        <div class="box-header">
        	<h3 class="box-title">@trans( 'cash_register.all_your_cash_register' )</h3>
        	<div class="box-tools">
