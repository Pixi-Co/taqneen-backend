...
<section class="content-header">
    <h1>@trans('cash_register.open_cash_register')</h1>
    <!-- <ol class="breadcrumb">
  ...
  <div class="box box-solid">
    ...
    <input type="hidden" name="sub_type" value="{{$sub_type}}">
      <div class="row">
        ...
        @endif
        <div class="col-sm-8 col-sm-offset-2 w3-center text-center">
          <br>
          <button type="submit" class="btn add_btn">@trans('cash_register.open_register')</button>
        </div>
        @else
        <div class="col-sm-8 col-sm-offset-2 text-center">
          <h3>@trans('lang_v1.no_location_access_found')</h3>
        </div>
      @endif
      </div>
      <br><br><br>
