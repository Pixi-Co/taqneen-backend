        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade" id="tab_1" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="panel">
                            ...
                            <label class="customcheck">
                                ...
                                <a href="#">
                                    <span class="fas fa-info-circle" data-toggle="tooltip"
                                        data-original-title="@trans('lang_v1.tooltip_enable_user_active')">
                                    </span>
                                </a>
                    ...
                    <center class="form_bottons d-flex justify-content-between"> 
                        <button type="button" class="btn learn_more_link  next" onclick="gototab(2)" >@trans('Next')</button>
                    </center>
                </div>
            </div>
            <div class="tab-pane fade" id="tab_2" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div class="panel">
                            ...
                            <div class="col-md-8 col-12">
                                <div class="form-check inner_checks">
                                    <label class="customcheck">
                                        ...
                                        <a href="#">
                                            <span class="fas fa-info-circle" data-toggle="tooltip"
                                                data-original-title="@trans('tooltip.all_location_permission')"></span>
                                        </a>
                                        {!! Form::checkbox('access_all_locations', 'access_all_locations', true, ['class' => 'input-icheck no-icheck']) !!}
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                @foreach ($locations as $location)
                                    <div class="form-check inner_checks">
                                        <label class="customcheck">
                                            {{ $location->name }}
                                            {!! Form::checkbox('location_permissions[]', 'location.' . $location->id, false, ['class' => 'input-icheck no-icheck']) !!}
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                @endforeach
                    ...
                    <center class="form_bottons d-flex justify-content-between">
                        <button type="button" class="btn learn_more_link previous" onclick="gototab(1)" > @trans('Previous')</button>
                        <button type="button" class="btn learn_more_link  next" onclick="gototab(3)" >@trans('Next')</button>
                    </center>
                </div>
            ...
            <div class="tab-pane fade" id="tab_3" role="tabpanel" aria-labelledby="pills-contact-tab">
                <div class="panel">
                                ...
                                <div class="col-md-6 col-12">
                                    <label class="customcheck">{{ __('lang_v1.allow_selected_contacts') }}
                                        <a href="#"><span class="fas fa-info-circle" data-toggle="tooltip"
                                                data-original-title="@trans('lang_v1.allow_selected_contacts_tooltip')"></span></a>
                                       
                                                
                                        {!! Form::checkbox('selected_contacts', 1, false, ['class' => 'checkbox1 no-icheck', 'id' => 'selected_contacts']) !!}
                                     
                                    </label>
                                </div>
                                <div class="col-md-6 col-12 ">
                                    <div id="autoUpdate" class="autoUpdate selected_contacts_div hide"  >
                                        {!! Form::label('selected_contacts', __('lang_v1.selected_contacts') . ':') !!}
                                        {!! Form::select('selected_contact_ids[]', $contacts, null, ['class' => 'form-control mySelect select2', 'multiple']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <center class="form_bottons d-flex justify-content-between">
                        <button class="btn learn_more_link previous" onclick="gototab(2)" >@trans('Previous')</button>
                        <button type="button" class="btn learn_more_link  next" onclick="gototab(4)" >@trans('Next')</button>
                    </center>
                </div>
                <div class="form_bottons d-flex justify-content-center">
                    <button type="submit" class="btn add_btn">Submit</button>
            ...
            <div class="tab-pane fade" id="tab_4" role="tabpanel" aria-labelledby="pills-contact-tab">
                <div class="panel">
                    ...
                    <br>
                    <center class="form_bottons d-flex justify-content-between">
                        <button type="button" class="btn learn_more_link previous" onclick="gototab(3)" > @trans('Previous')</button>
                        <button type="button" class="btn learn_more_link  next" onclick="gototab(5)" >@trans('Next')</button>
                    </center>
                </div> 
                <div class="form_bottons d-flex justify-content-center">
                    <button type="submit" class="btn add_btn">Submit</button>
            ...
            <div class="tab-pane fade" id="tab_5" role="tabpanel" aria-labelledby="pills-contact-tab">
                <div class="panel">
                    ...
                    <center class="form_bottons d-flex justify-content-between">
                        <button type="button" class="btn learn_more_link previous" onclick="gototab(4)" > @trans('Previous')</button>
                        <button type="button" class="btn learn_more_link  next" onclick="gototab(6)" >@trans('Next')</button>
                    </center>
                </div>
                <div class="form_bottons d-flex justify-content-center">
                    <button type="submit" class="btn add_btn">Submit</button>
            ...
            <div class="tab-pane fade" id="tab_6" role="tabpanel" aria-labelledby="pills-contact-tab">
                <div class="panel">
                    ...
                    <center class="form_bottons d-flex justify-content-between">
                        <button type="button" class="btn learn_more_link previous" onclick="gototab(5)" > @trans('Previous')</button>
                        <button type="button" class="btn learn_more_link  next" onclick="gototab(7)" >@trans('Next')</button>
                    </center>
                </div>
                <div class="form_bottons d-flex justify-content-center">
                    <button type="submit" class="btn add_btn">Submit</button>
            ...
            <div class="tab-pane fade" id="tab_7" role="tabpanel" aria-labelledby="pills-contact-tab">
                <div class="panel">
                    ...
                    <center class="form_bottons d-flex justify-content-between">
                        <button type="button" class="btn learn_more_link previous" onclick="gototab(6)" > @trans('Previous')</button> 
                    </center>
                </div>
                <div class="form_bottons d-flex justify-content-center">
                    <button type="submit" class="btn add_btn">Submit</button>
