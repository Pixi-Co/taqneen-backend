...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="user_auth_fields">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        'business.username' ) ]); !!}
                        @endif
                        <p class="help-block">@trans('lang_v1.username_help')</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="clearfix"></div>
            <div class="col-md-3">
                <h4>@trans( 'role.access_locations' ) @show_tooltip(__('tooltip.access_locations_permission'))</h4>
            </div>
            <div class="col-md-9">
                <div class="col-md-12">
                    <div class="checkbox">
    ...
    <div class="row">
        <div class="col-md-12">
            <button type="submit" class="btn btn-primary pull-right" id="submit_user_button">@trans( 'messages.save'
                )</button>
        </div>
    </div>
    {!! Form::close() !!}
