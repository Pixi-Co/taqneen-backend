    ...
    <div class="w3-padding">
        ...
        <div class="w3-row">
            <div class="w3-col l3 m3 s3" style="padding: 5px" > 
                ...
                <div class="w3-border w3-border-gray w3-center" style="padding: 5px">
            ...
            @if (!empty($receipt_details->footer_text))
                <div class="w3-col l9 m9 s9 " style="padding: 5px">
                    ...
                    <div class="row w3-tiny w3-border w3-border-gray " style="padding: 5px">
            ...
            <div class="w3-col l9 m9 s9" style="padding: 5px" > 
                ...
                @if ($receipt_details->commercial_number || $receipt_details->tax_number)
                <div class="w3-border w3-border-gray" style="padding: 5px"> 
