<div class="w3-padding">
	...
	<div class="row">
		...
		<div class="col-md-4 w3-padding" id="class_type_div" style="display: none" >
			<div class="form-group">
			{!! Form::select('class_type_id', Modules\Subscription\Entities\ClassType::active()->pluck('name', 'id')->toArray(), null, ['class' => 'form-control', 'placeholder' => __('select class type'), 'id' => 'class_type_id']); !!}
			</div>
		</div>
		@endcan_bt
		
		@can_bt(['subscription.session']) 
		<div class="col-md-4 w3-padding" id="session_div" style="display: none" >
			<div class="form-group">
			{!! Form::select('session_id', Subscription::loadAvailableSession()->pluck('name', 'id')->toArray(), null, ['class' => 'form-control', 'placeholder' => __('select session'), 'id' => 'session_id']); !!}
			</div>
		</div>
		@endcan_bt
