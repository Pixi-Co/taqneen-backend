		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row @if(!$is_rp_enabled) hide @endif">
				    ...
				    <div class="col-md-6">
				    	<p><strong>@trans('lang_v1.available'):</strong> <span id="available_rp">{{$max_available}}</span></p>
				    	<h5><strong>@trans('lang_v1.redeemed_amount'):</strong> <span id="rp_redeemed_amount_text">{{@num_format($rp_redeemed_amount)}}</span></h5>
				    </div>
				    </div>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="posEditDiscountModalUpdate">@trans('messages.update')</button>
