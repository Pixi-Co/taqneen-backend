<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@trans( 'purchase.edit_payment' )</h4>
    </div>
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="well">
            <strong>@trans('purchase.supplier'): </strong>{{ $transaction->contact->name }}<br>
        ...
        <div class="col-md-4">
          <div class="well">
            <strong>@trans('purchase.ref_no'): </strong>{{ $transaction->ref_no }}<br>
      ...
      <div class="row payment_row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <p class="help-block">@trans('lang_v1.previous_file_will_be_replaced')
