  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      @if(!empty($transaction->contact))
        <div class="col-md-4">
          <div class="well">
            ...
            <strong>@trans('business.business'): </strong>{{ $transaction->contact->supplier_business_name }}
            @endif
          </div>
        </div>
        @endif
        <div class="col-md-4">
          ...
          @if(in_array($transaction->type, ['sell', 'sell_return']))
            <strong>@trans('sale.invoice_no'): </strong>{{ $transaction->invoice_no }}
          @else
            <strong>@trans('purchase.ref_no'): </strong>{{ $transaction->ref_no }}
          @endif
          @if(!empty($transaction->location))
            <br>
            <strong>@trans('purchase.location'): </strong>{{ $transaction->location->name }}
          @endif
          </div>
        </div>
        <div class="col-md-4">
          <div class="well">
            <strong>@trans('sale.total_amount'): </strong><span class="display_currency" data-currency_symbol="true">{{ $transaction->final_total }}</span><br>
      ...
      <div class="row">
        <div class="col-md-12">
          @if(!empty($transaction->contact))
            <strong>@trans('lang_v1.advance_balance'):</strong> <span class="display_currency" data-currency_symbol="true">{{$transaction->contact->balance}}</span>
