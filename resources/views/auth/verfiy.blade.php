...
<body  style=" background: linear-gradient(-45deg, #fff, #fff);!important" >
    ...
    <div class="login-form  login_page"  >
        ...
        <form method="POST" action="{{ route('business.postverfiy') }}" id="login-form">
            {{ csrf_field() }}
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 animate__animated animate__fadeInRight">
                    <div class="border-0 ">
                        ...
                        <div class="row px-3   ">
                            <label class="mb-1">
                                <h6 class="mb-0 text-">@trans('email') </h6>
                            </label>
                            <input class="mb-4" required="" type="email" name="email" placeholder="@trans('email')" />
                        ...
                        <div class="row mb-3 px-3">
                            ...
                            <div class=" ">
                                <a href="{{ url('/login') }}" class="btn btn-blue text-center register_btn">
                                    @trans('login')
                                </a>
                            </div>
                        </div>
