...
<section class="content-header">
    <h1>@trans('lang_v1.bulk_edit_products')</h1>
</section>
		...
		<div class="col-md-12">
			<table class="table text-center table-bordered" id="product_table">
				<thead id="product_table_head">
					<tr class="bg-gray">
						<th class="col-md-1">@trans('sale.product')</th>
						<th class="col-md-2">@trans('product.category')</th>
						<th class="col-md-2">@trans('product.sub_category')</th>
						<th class="col-md-2">@trans('product.brand')</th>
                		<th class="col-md-2">@trans('product.tax')</th>
                		<th class="col-md-3">@trans('business.business_locations')</th>
					</tr>
				</thead>
