...
<tr class="variation_row">
    ...
    <td>
        <table class="table table-condensed table-bordered variation_value_table">
            <thead>
            <tr class=" w3-green" >
                <th>@trans('product.sku') @show_tooltip(__('tooltip.sub_sku'))</th>
                <th>@trans('product.value')</th>
                <th>@trans('lang_v1.variation')</th>
                <th>@trans('product.variation_values')</th>
                <th class="{{$class}}">@trans('product.default_purchase_price')
                    <br/>
                    <span class="pull-left"><small><i>@trans('product.exc_of_tax')</i></small></span>

                    <span class="pull-right"><small><i>@trans('product.inc_of_tax')</i></small></span>
                </th>
                <th class="{{$class}}">@trans('product.profit_percent')</th>
                <th class="{{$class}}">@trans('product.default_selling_price')
                <br/>
            ...
            <tr>
                    ...
                    <div class="width-50 f-left">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button" class="btn btn-default bg-white btn-flat apply-all btn-sm p-5-5" data-toggle="tooltip" title="@trans('lang_v1.apply_all')" data-target-class=".variable_dpp_inc_tax"><i class="fas fa-check-double"></i></button>
                            </span>
                        </div>
                    </div>
                </td>
                <td class="{{$class}}">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-default bg-white btn-flat apply-all btn-sm p-5-5" data-toggle="tooltip" title="@trans('lang_v1.apply_all')" data-target-class=".variable_profit_percent"><i class="fas fa-check-double"></i></button>
                        </span>
                    </div>
                </td>
                <td class="{{$class}}">
