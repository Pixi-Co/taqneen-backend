@if(empty($is_admin))
    <h3>@trans('business.business')</h3>
@endif
{!! Form::hidden('language', request()->lang); !!}

<fieldset>
<legend>@trans('business.business_details'):</legend>
<div class="col-md-6">
...
<div class="col-md-6">
    <div class="form-group">
        {!! Form::label('businesstype_id', __('business type') . ':*' ) !!}
        <div class="input-group">
            <span class="input-group-addon">
                <i class="fa fa-suitcase "></i>
            </span>
            <select name="businesstype_id" id="" required="" >
...
<!-- tax details -->
@if(empty($is_admin))
    <h3>@trans('business.business_settings')</h3>

    <fieldset>
    <legend>@trans('business.business_settings'):</legend>
    <div class="col-md-6">
        <div class="form-group">
...
<!-- Owner Information -->
@if(empty($is_admin))
    <h3>@trans('business.owner')</h3>
@endif

<fieldset>
<legend>@trans('business.owner_info')</legend>
<div class="col-md-4">
    <div class="form-group">
        ...
        <div class="form-group">
            <label>
                ...
                <u><a class="terms_condition cursor-pointer" data-toggle="modal" data-target="#tc_modal">
                    @trans('lang_v1.accept_terms_and_conditions') <i></i>
                </a></u>
            </label>
        </div>
