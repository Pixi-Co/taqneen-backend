<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('sales_cmsn_agnt', __('select sales_commission_agent') . ':') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-info"></i>
                    </span>
                    {!! Form::select('sales_cmsn_agnt', $commission_agent_dropdown, $business->sales_cmsn_agnt, ['onchange' => 'this.value == "cmsn_agnt"? $(".select_sales_commission_id_div").show() : $(".select_sales_commission_id_div").hide()', 'class' => 'form-control ', 'style' => 'width: 100%;']); !!}
                </div>
            </div>
        </div>
        
        <div class="col-sm-4">
            <div class="form-group select_sales_commission_id_div {{  $business->sales_cmsn_agnt == 'cmsn_agnt'? '' : 'hide' }}"  >
                {!! Form::label('select_sales_commission_id', __('lang_v1.sales_commission_agent') . ':') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-user"></i>
                    </span>
                    {!! Form::select('select_sales_commission_id', $sales_commission_agent, $business->select_sales_commission_id, ['class' => 'form-control ', 'style' => 'width: 100%;']); !!}
                </div>
            </div>
        </div>
