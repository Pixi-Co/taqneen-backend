<div class="pos-tab-content">
    ...
    <ul class="w3-ul">
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@trans('lang_v1.labels_for_custom_payments'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@trans('lang_v1.labels_for_contact_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@trans('lang_v1.labels_for_product_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@trans('lang_v1.labels_for_location_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@trans('lang_v1.labels_for_user_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@trans('lang_v1.labels_for_purchase_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@trans('lang_v1.labels_for_sell_custom_fields'):</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-addon">
                                    <label>
                                    <input type="checkbox" name="custom_labels[sell][is_custom_field_1_required]" value="1" @if(!empty($custom_labels['sell']['is_custom_field_1_required']) && $custom_labels['sell']['is_custom_field_1_required'] == 1) checked @endif > @trans('lang_v1.is_required')</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_labels[sell][custom_field_2]', !empty($custom_labels['sell']['custom_field_2']) ? $custom_labels['sell']['custom_field_2'] : null, 
                                ...
                                <div class="input-group-addon">
                                    <label>
                                    <input type="checkbox" name="custom_labels[sell][is_custom_field_2_required]" value="1" @if(!empty($custom_labels['sell']['is_custom_field_2_required']) && $custom_labels['sell']['is_custom_field_2_required'] == 1) checked @endif > @trans('lang_v1.is_required')</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-addon">
                                    <label>
                                    <input type="checkbox" name="custom_labels[sell][is_custom_field_3_required]" value="1" @if(!empty($custom_labels['sell']['is_custom_field_3_required']) && $custom_labels['sell']['is_custom_field_3_required'] == 1) checked @endif > @trans('lang_v1.is_required')</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-addon">
                                    <label>
                                    <input type="checkbox" name="custom_labels[sell][is_custom_field_4_required]" value="1" @if(!empty($custom_labels['sell']['is_custom_field_4_required']) && $custom_labels['sell']['is_custom_field_4_required'] == 1) checked @endif > @trans('lang_v1.is_required')</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@trans('lang_v1.labels_for_sale_shipping_custom_fields'):</div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_labels[shipping][custom_field_1]', !empty($custom_labels['shipping']['custom_field_1']) ? $custom_labels['shipping']['custom_field_1'] : null, 
                                ...
                                <div class="input-group-addon">
                                    <label>
                                    <input type="checkbox" name="custom_labels[shipping][is_custom_field_1_required]" value="1" @if(!empty($custom_labels['shipping']['is_custom_field_1_required']) && $custom_labels['shipping']['is_custom_field_1_required'] == 1) checked @endif > @trans('lang_v1.is_required')</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_labels[shipping][custom_field_2]', !empty($custom_labels['shipping']['custom_field_2']) ? $custom_labels['shipping']['custom_field_2'] : null, 
                                ...
                                <div class="input-group-addon">
                                    <label>
                                    <input type="checkbox" name="custom_labels[shipping][is_custom_field_2_required]" value="1" @if(!empty($custom_labels['shipping']['is_custom_field_2_required']) && $custom_labels['shipping']['is_custom_field_2_required'] == 1) checked @endif > @trans('lang_v1.is_required')</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_labels[shipping][custom_field_3]', !empty($custom_labels['shipping']['custom_field_3']) ? $custom_labels['shipping']['custom_field_3'] : null, 
                                ...
                                <div class="input-group-addon">
                                    <label>
                                    <input type="checkbox" name="custom_labels[shipping][is_custom_field_3_required]" value="1" @if(!empty($custom_labels['shipping']['is_custom_field_3_required']) && $custom_labels['shipping']['is_custom_field_3_required'] == 1) checked @endif > @trans('lang_v1.is_required')</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_labels[shipping][custom_field_4]', !empty($custom_labels['shipping']['custom_field_4']) ? $custom_labels['shipping']['custom_field_4'] : null, 
                                ...
                                <div class="input-group-addon">
                                    <label>
                                    <input type="checkbox" name="custom_labels[shipping][is_custom_field_4_required]" value="1" @if(!empty($custom_labels['shipping']['is_custom_field_4_required']) && $custom_labels['shipping']['is_custom_field_4_required'] == 1) checked @endif > @trans('lang_v1.is_required')</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('custom_labels[shipping][custom_field_5]', !empty($custom_labels['shipping']['custom_field_5']) ? $custom_labels['shipping']['custom_field_5'] : null, 
                                ...
                                <div class="input-group-addon">
                                    <label>
                                    <input type="checkbox" name="custom_labels[shipping][is_custom_field_5_required]" value="1" @if(!empty($custom_labels['shipping']['is_custom_field_5_required']) && $custom_labels['shipping']['is_custom_field_5_required'] == 1) checked @endif > @trans('lang_v1.is_required')</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@trans('lang_v1.labels_for_types_of_service_custom_fields'):</div>
