<div class="pos-tab-content">
    <h4>@trans('business.add_keyboard_shortcuts'):</h4>
    <p class="help-block">@trans('lang_v1.shortcut_help'); @trans('lang_v1.example'): <b>ctrl+shift+b</b>, <b>ctrl+h</b></p>
    <p class="help-block">
        <b>@trans('lang_v1.available_key_names_are'):</b>
    ...
    <div class="row">
        <div class="col-sm-6">
            <table class="table table-striped">
                <tr>
                    <th>@trans('business.operations')</th>
                    <th>@trans('business.keyboard_shortcut')</th>
                </tr>
                <tr>
                ...
                <tr>
                    <td>@trans('lang_v1.weighing_scale'):</td>
                    <td>
        ...
        <div class="col-sm-6">
            <table class="table table-striped">
                ...
                <tr>
                    <td>@trans('sale.edit_discount'):</td>
                    <td>
                ...
                <tr>
                    <td>@trans('sale.edit_order_tax'):</td>
                    <td>
                ...
                <tr>
                    <td>@trans('sale.add_payment_row'):</td>
                    <td>
                ...
                <tr>
                    <td>@trans('sale.finalize_payment'):</td>
                    <td>
                ...
                <tr>
                    <td>@trans('lang_v1.add_new_product'):</td>
                    <td>
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4>@trans('installment settings'):</h4>
        </div>

        <div class="col-sm-4">
            <div class="form-group">
                <label for="">
                    @trans('installment interval')
                </label>
                <select name="pos_settings[installment_interval]" class="form-control" id="installment_interval" >
                    <option value="day">@trans('day')</option>
                    <option value="month">@trans('month')</option>
                    <option value="year">@trans('year')</option>
                </select>
                <script>
                    $('#installment_interval').val('{{ $pos_settings['installment_interval']?? '' }}')
                </script> 
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <label for="">
                    @trans('installment interval number')
                </label>
                <input type="number" name="pos_settings[installment_interval_number]" class="form-control" value="{{ $pos_settings['installment_interval_number']?? '' }}" > 
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <label for="">
                    @trans('installment count')
                </label>
                <input type="number" name="pos_settings[installment_count]" class="form-control" value="{{ $pos_settings['installment_count']?? '' }}" > 
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[cant_edit_installment_interval]', 1,  
                        $pos_settings['cant_edit_installment_interval']?? 0 , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'cant_edit_installment_interval' ) }}
                  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[cant_edit_installment_interval_number]', 1,  
                        $pos_settings['cant_edit_installment_interval_number']?? 0 , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'cant_edit_installment_interval_number' ) }}
                  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[cant_edit_installment_count]', 1,  
                        $pos_settings['cant_edit_installment_count']?? 0 , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'cant_edit_installment_count' ) }}
                  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <h4>@trans('lang_v1.pos_settings'):</h4>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[disable_shipping]', 1,  
                        $pos_settings['disable_shipping']?? 0, 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'disable_shipping' ) }}
                  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[disable_quotation]', 1, isset($pos_settings['disable_quotation'])? $pos_settings['disable_quotation'] : false , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'disable_quotation' ) }}
                  </label>
                </div>
            </div>
        </div>
