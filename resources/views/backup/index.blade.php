          ...
          <div class="box-tools">
            <a id="create-new-backup-button" href="{{ url('backup/create') }}" class="btn btn-primary pull-right"
                     style="margin-bottom:2em;"><i
                          class="fa fa-plus"></i> @trans('lang_v1.create_new_backup')
            </a>
          </div>
        @endslot
        @if (count($backups))
                <table class="table table-striped table-bordered">
                  <thead>
                  <tr>
                      <th>@trans('lang_v1.file')</th>
                      <th>@trans('lang_v1.size')</th>
                      <th>@trans('lang_v1.date')</th>
                      <th>@trans('lang_v1.age')</th>
                            ...
                            <td>
                              <a class="btn btn-xs btn-success"
                                   href="{{action('BackUpController@download', [$backup['file_name']])}}"><i
                                        class="fa fa-cloud-download"></i> @trans('lang_v1.download')</a>
            ...
            @endif
            <br>
            <strong>@trans('lang_v1.auto_backup_instruction'):</strong><br>
            <code>{{$cron_job_command}}</code> <br>
            <strong>@trans('lang_v1.backup_clean_command_instruction'):</strong><br>
