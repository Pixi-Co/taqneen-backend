<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@trans( 'tax_rate.edit_taxt_rate' )</h4>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="row " > 
          <div class="col-sm-12 ">
            ...
            @include("layouts.partials.tooltip", ["text" => __('einvoice_tax_code')])
              {!! Form::select('einvoice_tax_code', $listOfTaxCodes, $tax_rate->einvoice_tax_code, ['class' => 'form-control select2 w3-light-gray']) !!}
          </div>
      </div>
      ...
      <div class="form-group">
        <div class="checkbox">
          <label>
             {!! Form::checkbox('for_tax_group', 1, !empty($tax_rate->for_tax_group), [ 'class' => 'input_icheck']); !!} @trans( 'lang_v1.for_tax_group_only' )
