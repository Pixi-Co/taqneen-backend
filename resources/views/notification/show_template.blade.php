...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@trans( 'lang_v1.send_notification' ) - {{$template_name}}</h4>
    </div>

    <div class="modal-body">
      <div class="form-group @if($notification_template['template_for'] == 'send_ledger') hide @endif">
        <label class="checkbox-inline">
          {!! Form::checkbox('notification_type[]', 'email', true, ['class' => 'input-icheck notification_type']); !!} @trans('lang_v1.send_email')
        </label>
        <label class="checkbox-inline">
          {!! Form::checkbox('notification_type[]', 'sms', false, ['class' => 'input-icheck notification_type']); !!} @trans('lang_v1.send_sms')
        </label>
        <label class="checkbox-inline">
          {!! Form::checkbox('notification_type[]', 'whatsapp', false, ['class' => 'input-icheck notification_type']); !!} @trans('lang_v1.send_whatsapp')
        </label>
      </div>
      <div id="email_div">
        ...
        @if($notification_template['template_for'] == 'send_ledger')
          <p class="help-block">*@trans('lang_v1.ledger_attacment_help')</p>
        @endif
      </div>
      <div class="form-group">
      ...
      <strong>@trans('lang_v1.available_tags'):</strong> <p class="help-block">{{implode(', ', $tags)}}</p>
    ...
    <div class="modal-footer">
      <button type="submit" class="btn btn-primary" id="send_notification_btn">@trans('lang_v1.send')</button>
...
// Fix for not updating textarea value on modal
  ...
  $('#send_notification_form').submit(function(e){
    ...
    btn.text("@trans('lang_v1.sending')...");
    ...
    $.ajax({
      ...
      success: function(result){
        ...
        $('#send_notification_btn').text("@trans('lang_v1.send')");
