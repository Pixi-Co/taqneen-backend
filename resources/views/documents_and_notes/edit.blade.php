<div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">@trans('lang_v1.edit_note')</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="is_private" value="1" @if($document_note->is_private) checked @endif> @trans('lang_v1.is_private')
                                    <i class="fa fa-info-circle" data-toggle="tooltip" title="@trans('lang_v1.note_will_be_visible_to_u_only')"></i>
                                </label>
                            </div>
                        </div>
                    </div>
