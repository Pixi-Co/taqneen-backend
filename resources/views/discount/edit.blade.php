<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@trans( 'sale.edit_discount' )</h4>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('applicable_in_spg', 1, !empty($discount->applicable_in_spg), ['class' => 'input-icheck']); !!} <strong>@trans('lang_v1.applicable_in_cpg')</strong>
            </label>
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('applicable_in_cg', 1, !empty($discount->applicable_in_cg), ['class' => 'input-icheck']); !!} <strong>@trans('lang_v1.applicable_in_cg')</strong>
            </label>
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('is_active', 1, !empty($discount->is_active), ['class' => 'input-icheck']); !!} <strong>@trans('lang_v1.is_active')</strong>
            </label>
          </div>
        </div>
