<div class="page-header "  ">
  <div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper col-auto p-0">
      <div class="logo-wrapper"><a href="{{url('/')}}"><img class="img-fluid" src="{{asset('assets/images/logo/logo.png')}}" alt=""></a></div>
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          <div class="media profile-media">
            ...
            <div class="media-body">
              ...
              <p class=" mb-0 font-roboto">{{ optional(auth()->user()->roles()->first())->name }} <i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
          <ul class="profile-dropdown onhover-show-div">
            <li><a  href="{{ route('user-profile.show',session('user.id')) }}"><i data-feather="user"></i><span>Account </span></a></li>
