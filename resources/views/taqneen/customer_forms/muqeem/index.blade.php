                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a role="button" href="{{ url('customer-form/subscribe_muqeem_model') }}" class="btn btn-primary" >@trans('new_customer_muqeem')</a>
                                        @endcan
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div style="width: 120px" >
                                                                    ...
                                                                    style="width: 30px;height: 30px;border-radius: 5em;padding: 5px;"
                                                                    href="{{ url('/customer-edit/subscribe_muqeem_model') }}/{{ $item->id }}">
