                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            @can(find_or_create_p('ticket_priority.create'))
                                                <a role="button" href="{{route('tickets.statues.create')}}" class="btn btn-primary" >@trans('add new')</a>
                                            @endcan
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                ...
                                                                @can(find_or_create_p('user.edit'))
                                                                    <a role="button" href="{{route('tickets.statues.edit',$status->id)}}" class="m-1 btn btn-warning btn-sm" ><i class="fa fa-edit"></i></a>
                                                                @endcan

                                                                @can(find_or_create_p('user.delete'))
                                                                    <button onclick="destroy('{{route('tickets.statues.delete',$status->id)}}')" class="m-1 btn btn-danger-gradien bt-sm" ><i class="fa fa-trash"></i></button>
                                                                @endcan
