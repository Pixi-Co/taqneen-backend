...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item">
        <a href="{{__('support.ticket_priorities')}}">@trans('ticket_priorities')</a>
    </li>
    <li class="breadcrumb-item active">@trans('add_ticket_priority')</li>
@endsection
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name" placeholder="@trans('ticket_priority_name')">
                                            @if($errors->has('name'))
