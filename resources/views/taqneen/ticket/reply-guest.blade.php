...
{{--                                                    </p>--}}
                                                    ...
                                                    @if(isset($ticketReply->file))
                                                        <div class="d-flex flex-row">
                                                            <a role="button" class="btn btn-sm" href="{{route('tickets.guest.reply.download.files',$ticketReply->id)}}"><i class="fa fa-download text-info"></i><small> @trans('download')</small></a>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
