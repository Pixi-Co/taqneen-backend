...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item">
        <a href="{{__('support.edit_ticket')}}">{{__('support.edit_ticket')}}</a>
    </li>
    <li class="breadcrumb-item active">{{__('support.edit_ticket')}}</li>
@endsection
                                                ...
                                                <select class="form-control select2">
                                                    ...
                                                    @if(count($users))
                                                        @foreach($users as $user)
                                                            <option value="{{$user->id}}" {{$user->id==$ticket->agent_id?'selected':''}}>{{$user->full_name}}</option>
                                                        @endforeach
                                                    @else
                                                        <option>@lang('messages.please_select')</option>
                                                    @endif
                                            ...
                                            <select class="form-control sub_departments" name="sub_department">
                                                ...
                                                @if(count($subDepartments))
                                                    @foreach($subDepartments as $sub_department)
                                                        <option class="{{$sub_department->parent_id}}" {{$sub_department->id==$ticket->department_id?"selected":""}} value="{{$sub_department->id}}">{{$sub_department->name}}</option>
                                                    @endforeach
                                                @else
                                                    <option>@lang('messages.please_select')</option>
                                                @endif
