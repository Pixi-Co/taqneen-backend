<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@trans( 'restaurant.edit_modifier' )</h4>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <h4>@trans( 'restaurant.modifiers' )</h4>
        </div>
        ...
        <div class="col-sm-12">
          <table class="table table-condensed" id="add-modifier-table">
            <thead>
              <tr>
                <th>@trans( 'restaurant.modifier')</th>
                <th>
                  @trans( 'lang_v1.price')
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="modifier_name_edit[{{$modifier->id}}]" 
                        class="form-control" value="{{$modifier->name}}" placeholder="@trans( 'lang_v1.name' )" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                      <input type="text" name="modifier_price_edit[{{$modifier->id}}]" 
                      class="form-control input_number" value="{{@num_format($modifier->sell_price_inc_tax)}}" placeholder="@trans( 'lang_v1.price' )" required>
                    </div>
                  </td>
                  <td>
                    @if(!$loop->first)
