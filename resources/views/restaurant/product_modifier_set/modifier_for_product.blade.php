...
<div>
  ...
  <i class="fa fa-external-link-alt cursor-pointer text-primary select-modifiers-btn" title="@trans('restaurant.modifiers_for_product')" data-toggle="modal" data-target="#{{$id}}"></i>
</div>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@trans( 'restaurant.modifiers_for_product' ): <span class="text-success"></span>
      </h4>
    </div>
