...
<div class="row">
    <div class="col-md-12 text-center">
        <h3>@trans( 'restaurant.all_orders' ) - @trans( 'restaurant.kitchen' ) @show_tooltip(__('lang_v1.tooltip_kitchen'))</h3>
    </div>
</div>
	...
	<div class="box">
        <div class="box-header">
            <button type="button" class="btn btn-sm btn-primary pull-right" id="refresh_orders"><i class="fas fa-sync"></i> @trans( 'restaurant.refresh' )</button>
        </div>
        <div class="box-body">
