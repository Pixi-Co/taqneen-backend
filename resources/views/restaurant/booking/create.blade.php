	...
	<div class="modal-dialog" role="document">
		...
		{!! Form::open(['url' => action('Restaurant\BookingController@store'), 'method' => 'post', 'id' => 'add_booking_form' ]) !!}
			<div class="modal-header">
				...
				<h4 class="modal-title">@trans( 'restaurant.add_booking' )</h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="col-sm-12">
						<div class="form-group">
						<div class="checkbox">
							{!! Form::checkbox('send_notification', 1, true, ['class' => 'input-icheck', 'id' => 'send_notification']); !!} @trans('restaurant.send_notification_to_customer')
						</div>
					</div>
				</div>
				</div>
