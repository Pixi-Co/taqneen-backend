...
<section class="content-header">
    <h1>@trans( 'restaurant.bookings' )</h1>
    <!-- <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <select id="business_location_id" class="select2" style="width:50%">
                <option value="">@trans('purchase.business_location')</option>
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@trans('restaurant.todays_bookings')</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table class="table table-bordered table-condensed" id="todays_bookings_table">
                        ...
                        <tr>
                            ...
                            <th>@trans('restaurant.booking_starts')</th>
                            <th>@trans('restaurant.booking_ends')</th>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <button type="button" class="btn btn-primary" id="add_new_booking_btn"><i class="fa fa-plus"></i> @trans('restaurant.add_booking')</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
            ...
            <div class="box box-solid">
                <div class="box-body">
                    ...
                    <div class="external-event bg-yellow text-center" style="position: relative;">
                        <small>@trans('lang_v1.waiting')</small>
                    </div>
                    <div class="external-event bg-light-blue text-center" style="position: relative;">
                        <small>@trans('restaurant.booked')</small>
                    </div>
                    <div class="external-event bg-green text-center" style="position: relative;">
                        <small>@trans('restaurant.completed')</small>
                    </div>
                    <div class="external-event bg-red text-center" style="position: relative;">
                        <small>@trans('restaurant.cancelled')</small>
                    </div>
                    <small>
                    <p class="help-block">
                        <i>@trans('restaurant.click_on_any_booking_to_view_or_change_status')<br><br>
                        @trans('restaurant.double_click_on_any_day_to_add_new_booking')
                        </i>
                    </p>
                    </small>
                </div>
