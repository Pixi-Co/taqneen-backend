...
<section class="content-header">
    <h1>@trans( 'account.balance_sheet')
    </h1>
</section>
...
<section class="content">
    <div class="row no-print">
        <div class="col-sm-12">
            <div class="col-sm-6 col-xs-6 ">
                    <label for="end_date">@trans('messages.filter_by_date'):</label>
                    <div class="input- "> 
    ...
    <div class="box box-solid">
        <div class="box-header print_section">
            <h3 class="box-title">{{session()->get('business.name')}} - @trans( 'account.balance_sheet') - <span id="hidden_date">{{@format_date('now')}}</span></h3>
        </div>
        <div class="box-body">
            <table class="table table-bordered">
                <thead>
                    <tr class="w3-green">
                        <th>@trans( 'account.liability')</th>
                        <th>@trans( 'account.assets')</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <table class="table">
                                <tr>
                                    <th>@trans('account.supplier_due'):</th>
                                <td>
                        ...
                        <td>
                            <table class="table" id="assets_table">
                                <tbody>
                                    <tr>
                                        <th>@trans('account.customer_due'):</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th>@trans('report.closing_stock'):</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th colspan="2">@trans('account.account_balances'):</th>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    <tr>
                                        <th colspan="2">@trans('account.capital_accounts'):</th>
                                    </tr>
                                </tbody>
