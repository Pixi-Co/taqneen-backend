...
<section class="content-header">
    <h1>@trans( 'account.trial_balance')
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header print_section">
            <h3 class="box-title">{{session()->get('business.name')}} - @trans( 'account.trial_balance') - <span id="hidden_date">{{@format_date('now')}}</span></h3>
        </div>
        <div class="box-body">
            <table class="table table-bordered" id="trial_balance_table">
                <thead>
                    <tr class="w3-green">
                        <th>@trans('account.trial_balance')</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <th>@trans('account.account_balances'):</th>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr>
                        <th>@trans('account.capital_accounts'):</th>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                </tbody>
