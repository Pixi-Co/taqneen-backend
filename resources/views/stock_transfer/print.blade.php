<div class="row">
  <div class="col-xs-12">
    <h2 class="page-header">
      @trans('lang_v1.stock_transfers') (<b>@trans('purchase.ref_no'):</b> #{{ $sell_transfer->ref_no }})
      <small class="pull-right"><b>@trans('messages.date'):</b> {{ @format_date($sell_transfer->transaction_date) }}</small>
    </h2>
  </div>
</div>
