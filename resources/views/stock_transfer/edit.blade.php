...
<section class="content-header">
    <h1>@trans('lang_v1.edit_stock_transfer')</h1>
</section>
		...
		<div class="box-body">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="text-left">
						<div class=""><b>@trans('stock_adjustment.total_amount'):</b> <span id="total_adjustment">{{@num_format($subtotal)}}</span></div>
					</div>
	...
	<div class="">
		<div class="text-center w3-padding">
			<button 
				...
				class="add_btn">@trans('messages.save')
			</button>
		</div>
	</div>
	{!! Form::close() !!}
