...
<section class="content-header">
    <h1>@trans('lang_v1.add_stock_transfer')</h1>
</section>
...
<section class="content no-print">
	...
	<div class="box box-solid w3-padding">
		...
		<div class="box-body">
			...
			<div class="text-left">
				<div class=""><b>@trans('stock_adjustment.total_amount'):</b> <span id="total_adjustment">0.00</span></div>
			</div>
		</div>
	</div> <!--box end-->
	<div class="box box-solid w3-padding">
	...
	<div class="">
		<div class="text-center w3-padding">
			<button type="submit" id="save_stock_transfer" class="add_btn">@trans('messages.save')</button>
		</div>
	</div>
	{!! Form::close() !!}
</section>
