<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@trans( 'account.add_account' )</h4>
    </div>
    ...
    <div class="modal-body">
            ...
            <div class="form-group">
              <div class="checkbox category-check-container">
                  <label>
                    {!! Form::checkbox('is_for_discount', 0, false,[ 'class' => 'icheck', 'data-toggle_id' => '' ]); !!} @trans( 'is_for_discounts' )
                  </label>
                </div>
            </div>
            ...
            <div class="form-group">
              <div class="checkbox category-check-container">
                  <label>
                    {!! Form::checkbox('is_for_tax', 0, false,[ 'class' => 'icheck', 'data-toggle_id' => '' ]); !!} @trans( 'is_for_taxs' )
                  </label>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                @include("layouts.js.jstree_option", ["id" => "js_tree_account_type_create"]) 
            </div>
...
@include("layouts.js.jtree", ["id" => "js_tree_account_type_create", "selectedId" => null])
