...
<section class="content-header">
    <h1>@trans('expense.add_expense')</h1>
</section>
			...
			<div class="row">
				...
				<div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <small><p class="help-block">@trans('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
				...
				<div class="col-sm-6">
					<br>
					<label>
		              {!! Form::checkbox('is_refund', 1, false, ['class' => 'input-icheck', 'id' => 'is_refund']); !!} @trans('lang_v1.is_refund')?
	...
	<div class="payment_row">
		...
		<div class="row">
			<div class="text-center w3-xlarge w3-padding">
				<div class="">
					<strong>@trans('purchase.payment_due'):</strong>
