	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-4 col-sm-6">
				<br>
				<label>
	              {!! Form::checkbox('is_recurring', 1, !empty($expense->is_recurring) == 1, ['class' => 'input-icheck', 'id' => 'is_recurring']); !!} @trans('lang_v1.is_recurring')?
		    ...
		    <div class="col-md-4 col-sm-6">
		        <div class="form-group">
			        ...
			        <p class="help-block">@trans('lang_v1.recur_expense_repetition_help')</p>
		        </div>
		    </div>
		    @php
		    	$repetitions = [];
