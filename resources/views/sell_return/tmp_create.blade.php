...
<section class="content no-print">
				...
				<div class="col-sm-12">
					...
					<div class="pull-right col-md-5">
						<table class="pull-right col-md-12">
							...
							<tr>
								<th class="col-md-7 text-right">@trans( 'purchase.net_total_amount' ):</th>
								<td class="col-md-5 text-left">
	...
	<div class="box box-solid"><!--box start-->
				...
				<table class="table">
					...
					<tr>
						...
						<td>
							...
							<b>@trans('lang_v1.total_credit_amt'): </b><span id="total_payable" class="display_currency" data-currency_symbol='true'>0</span>
						</td>
					</tr>
					<tr>
						<td colspan="4">
		...
		<div class="row">
		<div class="col-sm-12">
			<button type="button" id="submit_sell_return_form" class="btn btn-primary pull-right btn-flat">@trans('messages.save')</button>
		</div>
		</div>
