<tr class="product_row">
	<td>
		...
		<i class="fa fa-commenting cursor-pointer text-primary add-pos-row-description" title="@trans('lang_v1.add_description')" data-toggle="modal" data-target="#row_description_modal_{{$row_count}}"></i>
	</td>
	<td>
		...
		data-rule-required="true" data-msg-required="@trans('validation.custom-messages.this_field_is_required')" >
