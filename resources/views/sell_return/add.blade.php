...
<section class="content-header no-print">
    <h1>@trans('lang_v1.sell_return')</h1>
</section>
...
{!! Form::hidden('location_id', $sell->location->id, ['id' => 'location_id', 'data-receipt_printer_type' => $sell->location->receipt_printer_type ]); !!}
	...
	<div class="box box-solid w3-padding w3-round w3-white">
		<div class="box-header">
			<h3 class="box-title">@trans('lang_v1.parent_sale')</h3>
		</div>
		<div class="box-body">
			<div class="row">
				<div class="col-sm-4">
		...
		<div class="box-body">
					...
					<table class="table bg-gray" id="sell_return_table">
			          	<thead>
				            <tr class="bg-green">
				              	...
				              	<th>@trans('lang_v1.sell_quantity')</th>
				            ...
				            <tr>
				              	...
				              	<td>
						            ...
						            data-msg-abs_digit="@trans('lang_v1.decimal_value_not_allowed')"
			              			...
			              			data-msg-max-value="@trans('validation.custom-messages.quantity_not_available', ['qty' => $sell_line->formatted_qty, 'unit' => $unit_name ])" 
						            >
			...
			<div class="row">
				<div class="col-sm-12 text-right">
					<strong>@trans('lang_v1.total_return_discount'):</strong> 
					&nbsp;(-) <span id="total_return_discount"></span>
				</div>
				<div class="col-sm-12 text-right">
					<strong>@trans('lang_v1.total_return_tax') - @if(!empty($sell->tax))({{$sell->tax->name}} - {{$sell->tax->amount}}%)@endif : </strong> 
					&nbsp;(+) <span id="total_return_tax"></span>
				</div>
				<div class="col-sm-12 text-right">
					<strong>@trans('lang_v1.return_total'): </strong>&nbsp;
