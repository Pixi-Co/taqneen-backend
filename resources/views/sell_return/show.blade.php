<div class="modal-dialog modal-xl no-print" role="document">
  <div class="modal-content">
    ...
    <h4 class="modal-title" id="modalTitle"> @trans('lang_v1.sell_return') (<b>@trans('sale.invoice_no'):</b> {{ $sell->return_parent->invoice_no }})
    </h4>
</div>
<div class="modal-body">
   <div class="row">
      <div class="col-sm-6 col-xs-6">
        <h4>@trans('lang_v1.sell_return_details'):</h4>
        <strong>@trans('lang_v1.return_date'):</strong> {{@format_date($sell->return_parent->transaction_date)}}<br>
        <strong>@trans('contact.customer'):</strong> {{ $sell->contact->name }} <br>
        <strong>@trans('purchase.business_location'):</strong> {{ $sell->location->name }}
      </div>
      <div class="col-sm-6 col-xs-6">
        <h4>@trans('lang_v1.sell_details'):</h4>
        <strong>@trans('sale.invoice_no'):</strong> {{ $sell->invoice_no }} <br>
        <strong>@trans('messages.date'):</strong> {{@format_date($sell->transaction_date)}}
      </div>
    </div>
    <br>
    <div class="row">
  ...
  <div class="row">
    <div class="col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
      <table class="table">
        ...
        <tr>
          <th>@trans('lang_v1.return_discount'): </th>
          <td><b>(-)</b></td>
...
<div class="modal-footer">
    <a href="#" class="print-invoice btn btn-primary" data-href="{{action('SellReturnController@printInvoice', [$sell->return_parent->id])}}"><i class="fa fa-print" aria-hidden="true"></i> @trans("messages.print")</a>
