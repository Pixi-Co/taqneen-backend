  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        {!! Form::select('account_id', App\Account::forDropdown(null, null), $category->account_id, ['class' => 'form-control']); !!}
      </div>
      @if($cat_code_enabled)
      <div class="form-group">
      ...
      @if(!empty($parent_categories) && $enable_sub_category)
          <div class="form-group">
            <div class="checkbox">
              <label>
                 {!! Form::checkbox('add_as_sub_cat', 1, !$is_parent,[ 'class' => 'toggler', 'data-toggle_id' => 'parent_cat_div' ]); !!} @trans( 'lang_v1.add_as_sub_txonomy' )
              </label>
            </div>
          </div>
