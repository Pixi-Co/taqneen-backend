                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <p class="help-block">
                                @trans("lang_v1.pls_upload_valid_zip_file")
                            </p>
                        </div>
                    </div>
    ...
    @component('components.widget')
        <table class="table">
            <tr class="success">
                ...
                <th class="col-md-4">@trans('lang_v1.modules')</th>
                <th class="col-md-7">@trans('lang_v1.description')</th>
            </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if(!$module['is_installed'])
                            ...
                            @if($is_demo)
                                href="#"
                                title="@trans('lang_v1.disabled_in_demo')"
                                disabled
                            @else
                                href="{{$module['install_link']}}"
                            @endif
                            > @trans('lang_v1.install')</a>
                        @else
                    ...
                    <td>
                        ...
                        @isset($module['version'])
                            <small class="label bg-gray">@trans('lang_v1.version') {{$module['version']['installed_version']}}</small>
                        @endisset

                        @if(!empty($module['version']) && $module['version']['is_update_available'])
                            <div class="alert alert-warning mt-5">
                                <i class="fas fa-sync"></i> @trans('lang_v1.module_new_version', ['module' => $module['name'], 'link' => $module['update_link']]) 
                            </div>
                        @endif
                    </td>
                </tr>
