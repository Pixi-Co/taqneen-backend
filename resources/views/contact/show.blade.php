...
<section class="content no-print">
    <div class="row no-print">
        <div class="col-md-4">
            <h3>@trans('contact.view_contact')</h3>
        </div>
                ...
                <ul class="nav nav-pills mb-3 setting-tabs w3-padding">
                    ...
                    class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                        <a class="nav-link " href="#ledger_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-scroll" aria-hidden="true"></i> @trans('lang_v1.ledger')</a>
                    </li>
                        ...
                        onclick="editDatatable()" 
                         class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                            <a class="nav-link " href="#purchases_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-arrow-circle-down" aria-hidden="true"></i> @trans( 'purchase.purchases')</a>
                        </li>
                        <li
                        onclick="editDatatable()" 
                         class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                            <a class="nav-link " href="#stock_report_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-hourglass-half" aria-hidden="true"></i> @trans( 'report.stock_report')</a>
                        </li>
                    @endif
                        ...
                        onclick="editDatatable()" 
                         class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                            <a class="nav-link " href="#sales_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-arrow-circle-up" aria-hidden="true"></i> @trans( 'sale.sells')</a>
                        </li>
                            ...
                            onclick="editDatatable()" 
                             class="nav-item
                                ...
                                @else
                                    ''
                                @endif">
                                <a class="nav-link " href="#subscriptions_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-recycle" aria-hidden="true"></i> @trans( 'lang_v1.subscriptions')</a>
                            </li>
                        @endif
                    @endif
                    <li
                    onclick="editDatatable()" 
                     class="nav-item
                            ...
                            @endif
                            ">
                        <a class="nav-link " href="#documents_and_notes_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-paperclip" aria-hidden="true"></i> @trans('lang_v1.documents_and_notes')</a>
                    </li>
                    <li
                    onclick="editDatatable()" 
                     class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                        <a  class="nav-link " href="#payments_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-money-bill-alt" aria-hidden="true"></i> @trans('sale.payments')</a>
                    </li>
                    ...
                    onclick="editDatatable()" 
                     class="nav-item
                        ...
                        @else
                            ''
                        @endif">
                        <a class="nav-link " href="#activities_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-pen-square" aria-hidden="true"></i> @trans('lang_v1.activities')</a>
                        </li>
                    ...
                    @endif
                    <li
                    onclick="loadInstallmentsOfContact('{{ $contact->id }}', '#installments_tab')" 
                     class="nav-item
                            @if(!empty($view_type) &&  $view_type == 'installments')
                                active
                            @else
                                ''
                            @endif
                            ">
                        <a class="nav-link " href="#installments_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-money" aria-hidden="true"></i> @trans('installments')</a>
                    </li>
                                    ...
                                    id="rp_log_table" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>@trans('lang_v1.earned')</th>
                                                <th>@trans('lang_v1.redeemed')</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
