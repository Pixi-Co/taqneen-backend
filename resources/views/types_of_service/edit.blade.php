<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@trans( 'lang_v1.edit_type_of_service' )</h4>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="form-group col-md-12">
          <div class="checkbox">
            <label>
               {!! Form::checkbox('enable_custom_fields', 1, !empty($type_of_service->enable_custom_fields)); !!} @trans( 'lang_v1.enable_custom_fields' )
