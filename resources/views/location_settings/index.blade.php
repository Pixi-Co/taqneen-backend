...
<section class="content-header">
    <h1>@trans( 'messages.business_location_settings' ) - {{$location->name}}</h1>
    <!-- <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">@trans('receipt.receipt_settings')</a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    <div class="row">
                        <div class="col-md-12">
                            <h4>@trans( 'receipt.receipt_settings')
                                <small>@trans( 'receipt.receipt_settings_mgs')</small>
                            </h4>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <button class="btn btn-primary pull-right" type="submit">@trans('messages.update')</button>
                            </div>
                        </div>
                        {!! Form::close() !!}
                        </div>
