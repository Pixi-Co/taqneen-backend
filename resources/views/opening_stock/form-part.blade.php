        ...
        @forelse($locations as $key => $value)
            <div class="box- box-solid-">
                <div class="box-header-">
                    <h3 class="box-title-">@trans('sale.location'): {{ $value }}</h3>
                </div>
                <div class="box-body-">
                    <div class="row">
                        <div class="col-sm-12">
                            <table
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        @endif
                                        <th>@trans( 'purchase.subtotal_before_tax' )</th>
                                        <th>&nbsp;</th>
                                    </tr>
                                </thead>
                                <tbody>
      ...
      {{ $product->name }} @if ($product->type == ' variable')
        ...
        <tfoot>
            <tr>
                ...
                <td><strong>@trans( 'lang_v1.total_amount_exc_tax' ): </strong> <span
...
<!--box end-->
@empty
<h3>@trans( 'lang_v1.product_not_assigned_to_any_location' )</h3>
@endforelse
</div>
</div>
