<div class="row">
	...
	<div class="col-md-4 col-xs-4">
		<strong>@trans('lang_v1.quantities_out')</strong>
		<table class="table table-condensed">
			<tr>
			...
			<tr>
				<th>@trans('lang_v1.stock_transfers') (@trans('lang_v1.out'))</th>
				<td>
	...
	<div class="col-md-4 col-xs-4">
		<strong>@trans('lang_v1.totals')</strong>
		<table class="table table-condensed">
			<tr>
...
<div class="row">
	<div class="col-md-12">
		...
		<table class="table table-slim" id="stock_history_table">
			<thead>
			<tr>
				<th>@trans('lang_v1.type')</th>
				<th>@trans('lang_v1.quantity_change')</th>
				<th>@trans('lang_v1.new_quantity')</th>
			...
			@empty
				<tr><td colspan="5" class="text-center">
					@trans('lang_v1.no_stock_history_found')
				</td></tr>
			@endforelse
			</tbody>
		</table>
