	...
	<div class="modal-content">
	    ...
	    <div class="modal-body">
      		<div class="row">
      			<div class="col-sm-9">
	      			<div class="col-sm-4 invoice-col">
						...
						@endif
						<br>
						<strong>@trans('lang_v1.available_in_locations'):</strong>
						...
						@if(!empty($product->media->first())) <br>
							<strong>@trans('lang_v1.product_brochure'):</strong>
	      			...
	      			<div class="col-sm-4 invoice-col">
						...
						<b>@trans('product.manage_stock'): </b>
						...
						<br>
						@if($product->enable_stock)
							<b>@trans('product.alert_quantity'): </b>
      		...
      		@if(session('business.enable_racks') || session('business.enable_row') || session('business.enable_position'))
      			<div class="row">
      				<div class="col-md-12">
      					<h4>@trans('lang_v1.rack_details'):</h4>
      				</div>
      				<div class="col-md-12">
      					...
      					<table class="table table-condensed bg-gray">
      						<tr class="bg-green">
      							...
      							@if(session('business.enable_racks'))
      								<th>@trans('lang_v1.rack')</th>
      							@endif
      							@if(session('business.enable_row'))
      								<th>@trans('lang_v1.row')</th>
      							@endif
      							@if(session('business.enable_position'))
      								<th>@trans('lang_v1.position')</th>
      							@endif
      							</tr>
      		...
      		@if($product->enable_stock == 1)
	      		<div class="row">
	      			<div class="col-md-12">
	      				<strong>@trans('lang_v1.product_stock_details')</strong>
	      			</div>
