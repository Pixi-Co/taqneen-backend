...
@section('content')
    ...
    <section class="content-header">
        <h1>@trans('product.add_new_product')</h1>
    </section>
    ...
    <section class="content">
        ...
        <div class="w3-">
            {!! Form::open(['url' => action('ProductController@store'), 'method' => 'post', 'id' => 'product_add_form', 'class' => 'product_form' . $form_class, 'files' => true]) !!}
            @component('components.widget', ['class' => 'box-primary w3-padding'])
                <div class="w3-padding">
                    <d class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 w3-padding @if (!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" style="display: none"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 w3-padding">
                            <div class="form-group">
                                ...
                                <small>
                                    <b>@trans('purchase.max_file_size', ['size' => (config('constants.document_size_limit') /
                                        1000000)]) - </b>
                                    <b>@trans('lang_v1.aspect_ratio_should_be_1_1')</b>
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 w3-padding">
                            <div class="form-group">
                                <br>
                                <label>
                                    {!! Form::checkbox('enable_stock', 1, !empty($duplicate_product) ? $duplicate_product->enable_stock : true, ['class' => 'input-icheck2', 'id' => 'enable_stock']) !!} <strong>@trans('product.manage_stock')</strong>
                                </label>@show_tooltip(__('tooltip.enable_stock')) <p class="help-block">
                                    <i>@trans('product.enable_stock_help')</i>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 w3-padding">
                            <div class="form-group">
                                ...
                                <small>
                                    <p class="help-block">
                                        @trans('purchase.max_file_size', ['size' => (config('constants.document_size_limit') /
                                        1000000)])
                        ...
                        <!--
                                        <div class="col-lg-4 col-md-4 col-sm-6">
                                            <div class="form-group">
                                                <br>
                                                <label>
                                                    {!! Form::checkbox('not_for_selling', 1, !empty($duplicate_product) ? $duplicate_product->not_for_selling : false, ['class' => 'input-icheck2']) !!} <strong>@trans('lang_v1.not_for_selling')</strong>
                                ...
                                <div class="btn-group">
                                    ...
                                    @if ($selling_price_group_count)
                                        <button type="submit" value="submit_n_add_selling_prices"
                                            class="btn btn-warning submit_product_form">@trans('lang_v1.save_n_add_selling_price_group_prices')</button>
                                    @endif
                                    ...
                                    @can('product.opening_stock')
                                                <button id="opening_stock_button" @if (!empty($duplicate_product) && $duplicate_product->enable_stock == 0) disabled @endif type="submit" value="submit_n_add_opening_stock"
                                                    class="btn bg-purple submit_product_form">@trans('lang_v1.save_n_add_opening_stock')</button>
                                    @endcan

                                    <button type="submit" value="save_n_add_another"
                                        class="btn bg-maroon submit_product_form">@trans('lang_v1.save_n_add_another')</button>
                                    -->

                                    <button type="submit" value="submit"
                                        class="btn btn-primary submit_product_form">@trans('messages.save')</button>
                                </div>
