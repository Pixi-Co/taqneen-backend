	    	...
	    	{!! Form::open(['url' => action('ProductController@updateProductLocation'), 'method' => 'post', 'id' => 'edit_product_location_form' ]) !!}
		    	<div class="modal-header">
			    	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				      <h4 class="modal-title"><span class="add_to_location_title hide">@trans( 'lang_v1.add_location_to_the_selected_products' )</span><span class="remove_from_location_title hide">@trans( 'lang_v1.remove_location_from_the_selected_products' )</span></h4>
			    </div>
			    ...
			    <div class="modal-footer">
		      		<button type="submit" class="btn btn-primary" id="update_product_location">@trans( 'messages.save' )</button>
