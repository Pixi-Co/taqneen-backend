...
<div class="col-sm-12">
<h4>@trans('product.add_variation'):* <button type="button" class="btn btn-primary" id="add_variation" data-action="add">+</button></h4>
</div>
<div class="col-sm-12">
    ...
    <table class="table table-bordered add-product-price-table table-condensed" id="product_variation_form_part">
        <thead>
          <tr>
            <th class="col-sm-2">@trans('lang_v1.variation')</th>
            <th class="col-sm-10">@trans('product.variation_values')</th>
          </tr>
        </thead>
        <tbody>
            @if($action == 'add')
