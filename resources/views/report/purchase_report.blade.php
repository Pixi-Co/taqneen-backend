...
<section class="content-header no-print">
    <h1>Report 606 (@trans('lang_v1.purchase'))
    </h1>
</section>
    ...
    <table class="table table-bordered table-striped ajax_view" id="purchase_report_table">
        <thead>
            <tr>
                ...
                <th>@trans('purchase.purchase_date') (@trans('lang_v1.year_month'))</th>
                <th>@trans('purchase.purchase_date') (@trans('lang_v1.day'))</th>
                <th>@trans('lang_v1.payment_date') (@trans('lang_v1.year_month'))</th>
                <th>@trans('lang_v1.payment_date') (@trans('lang_v1.day'))</th>
                <th>@trans('sale.total') (@trans('product.exc_of_tax'))</th>
                <th>@trans('sale.discount')</th>
                <th>@trans('sale.tax')</th>
                <th>@trans('sale.total') (@trans('product.inc_of_tax'))</th>
