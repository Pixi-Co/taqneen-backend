...
<section class="content-header">
    <h1>@trans( 'report.tax_report' )
        <small>@trans( 'report.tax_report_msg' )</small>
    </h1>
</section>
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-pills  setting-tabs w3-block w3-padding">
                    <li class="nav-item active" onclick="editDatatable()">
                        <a class="nav-link" href="#input_tax_tab" data-toggle="tab" aria-expanded="true"><i class="fa fas fa-arrow-circle-down" aria-hidden="true"></i> @trans('report.input_tax')</a>
                    </li>

                    <li class="nav-item" onclick="editDatatable()">
                        <a class="nav-link" href="#output_tax_tab" data-toggle="tab" aria-expanded="true"><i class="fa fas fa-arrow-circle-up" aria-hidden="true"></i> @trans('report.output_tax')</a>
                    </li>

                    <li class="nav-item" onclick="editDatatable()">
                        <a class="nav-link" href="#expense_tax_tab" data-toggle="tab" aria-expanded="true"><i class="fa fas fa-minus-circle" aria-hidden="true"></i> @trans('lang_v1.expense_tax')</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active w3-light-gray table-responsive" id="input_tax_tab">
                        <table data-title="@trans('report.input_tax')" class="table table-bordered table-striped" id="input_tax_table">
                            <thead>
                                <tr>
                    ...
                    <div class="tab-pane w3-light-gray table-responsive" id="output_tax_tab">
                        <table data-title="@trans('report.output_tax')" class="table table-bordered table-striped" id="output_tax_table" width="100%">
                            <thead>
                                <tr>
                                    <th>@trans('messages.date')</th>
                    ...
                    <div class="tab-pane w3-light-gray table-responsive" id="expense_tax_tab">
                        <table data-title="@trans('lang_v1.expense_tax')" class="table table-bordered table-striped" id="expense_tax_table" width="100%">
                            <thead>
                                <tr>
                                    <th>@trans('messages.date')</th>
                                    <th>@trans('purchase.ref_no')</th>
