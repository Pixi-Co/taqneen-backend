            ...
            <div class="nav-tabs-custom w3-padding">
                <ul class="nav nav-pills  setting-tabs w3-block">
                    <li class="nav-item active" onclick="editDatatable()" >
                        <a class="nav-link" href="#profit_by_products" data-toggle="tab" aria-expanded="true"><i class="fa fa-cubes" aria-hidden="true"></i> @trans('lang_v1.profit_by_products')</a>
                    </li>

                    <li class="nav-item" onclick="editDatatable()" > 
                        <a class="nav-link" href="#profit_by_categories" data-toggle="tab" aria-expanded="true"><i class="fa fa-tags" aria-hidden="true"></i> @trans('lang_v1.profit_by_categories')</a>
                    </li>

                    <li class="nav-item" onclick="editDatatable()" >
                        <a class="nav-link" href="#profit_by_brands" data-toggle="tab" aria-expanded="true"><i class="fa fa-diamond" aria-hidden="true"></i> @trans('lang_v1.profit_by_brands')</a>
                    </li>

                    <li class="nav-item" onclick="editDatatable()" >
                        <a class="nav-link" href="#profit_by_locations" data-toggle="tab" aria-expanded="true"><i class="fa fa-map-marker" aria-hidden="true"></i> @trans('lang_v1.profit_by_locations')</a>
                    </li>

                    <li class="nav-item" onclick="editDatatable()" >
                        <a class="nav-link" href="#profit_by_invoice" data-toggle="tab" aria-expanded="true"><i class="fa fa-file-alt" aria-hidden="true"></i> @trans('lang_v1.profit_by_invoice')</a>
                    </li>

                    <li class="nav-item" onclick="editDatatable()" >
                        <a class="nav-link" href="#profit_by_date" data-toggle="tab" aria-expanded="true"><i class="fa fa-calendar" aria-hidden="true"></i> @trans('lang_v1.profit_by_date')</a>
                    </li>
                    <li class="nav-item" onclick="editDatatable()" >
                        <a class="nav-link" href="#profit_by_customer" data-toggle="tab" aria-expanded="true"><i class="fa fa-user" aria-hidden="true"></i> @trans('lang_v1.profit_by_customer')</a>
                    </li>
                    <li class="nav-item" onclick="editDatatable()" >
                        <a class="nav-link" href="#profit_by_day" data-toggle="tab" aria-expanded="true"><i class="fa fa-calendar" aria-hidden="true"></i> @trans('lang_v1.profit_by_day')</a>
                    </li>
                </ul>
                ...
                <div class="row no-print text-center">
                    <div class="text-center">
                        ...
                        ><i class="fa fa-print"></i> @trans( 'messages.print' )</button>
                    </div>
                </div>
                <br>
            </div>
