 ...
 <section class="content-header hidden">
     <h1>@trans( 'lang_v1.selling_price_group' )
     </h1>
     <!-- <ol class="breadcrumb">
         ...
         <div class="row">
             <div class="col-sm-6">
                 <a href="{{ action('SellingPriceGroupController@export') }}"
                     class="btn btn-primary">@trans('lang_v1.export_selling_price_group_prices')</a>
             </div>
             <div class="col-sm-6">
             ...
             <div class="col-sm-12">
                 <h4>@trans('lang_v1.instructions'):</h4>
                 <p>
                     &bull; @trans('lang_v1.price_group_import_istruction')
                 </p>
                 <p>
                     &bull; @trans('lang_v1.price_group_import_istruction1')
                 </p>
                 <p>
                     &bull; @trans('lang_v1.price_group_import_istruction2')
                 </p>
             </div>
         </div>
     @endcomponent
