...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
		...
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid w3-padding'])
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<p class="help-block">@trans('lang_v1.keep_blank_to_autogenerate')</p>
					</div>
				</div>
				@endcan
				@php
			...
			@endphp
			    ...
			    <div class="hidden col-md-12 well well-sm bg-light-gray @if(session('business.enable_rp') != 1) hide @endif">
				    ...
				    <div class="col-md-4">
				    	<p><strong>@trans('lang_v1.available'):</strong> <span id="available_rp">0</span></p>
				    </div>
				    <div class="col-md-4">
				    	<p><strong>@trans('lang_v1.redeemed_amount'):</strong> (-)<span id="rp_redeemed_amount_text">0</span></p>
				    </div>
			    </div>  			
			...
			<div class="payment_row">
				...
				<div class="row">
					<div class="col-sm-12 text-center w3-large">
						<div class=""><strong>@trans('lang_v1.balance'):</strong> <span class="balance_due">0.00</span></div>
					</div>
				</div>
			</div>
			@endcomponent
	...
	<center class="">
		...
		<div class="">
			<button type="button" id="submit-sell" class="add_btn">@trans('messages.save')</button>
			<button type="button" id="save-and-print" style="width: 220px" class="add_btn">@trans('lang_v1.save_and_print')</button>
		</div>
	</center>
