...
<section class="content-header">
    <h1>@trans('sale.edit_sale') <small>(@trans('sale.invoice_no'): <span class="text-success">#{{$transaction->invoice_no}})</span></small></h1>
</section>
<!-- Main content -->
...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
		...
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid w3-padding'])
				...
				@if(in_array('types_of_service', $enabled_modules) && !empty($transaction->types_of_service))
					<div class="col-md-4 col-sm-6">
						<div class="form-group">
							...
							<small><p class="help-block @if(empty($transaction->selling_price_group_id)) hide @endif" id="price_group_text">@trans('lang_v1.price_group'): <span>@if(!empty($transaction->selling_price_group_id)){{$transaction->price_group->name}}@endif</span></p></small>
						</div>
					</div>
				...
				@if(in_array('subscription', $enabled_modules))
					<div class="col-md-4">
						<div class="checkbox">
							<label>
				              {!! Form::checkbox('is_recurring', 1, $transaction->is_recurring, ['class' => 'input-icheck', 'id' => 'is_recurring']); !!} @trans('lang_v1.subscribe')?
				...
				<div class="col-md-4 @if(!empty($commission_agent)) c @else c @endif">
					...
					<small class="hidden" >
						...
						<br>
						<strong>
							@trans('lang_v1.shipping_address'):
						</strong>
			...
			@endphp
					...
					<div class="col-sm-6">
						<div class="pr-card">
							...
							<div class="w3-block text-center"><br>
								<b>@trans( 'sale.discount_amount' ):</b>(-) 
			    ...
			    <div class="hidden col-md-12 well well-sm bg-light-gray @if(session('business.enable_rp') != 1) hide @endif">
				    ...
				    <div class="col-md-4">
				    	<p><strong>@trans('lang_v1.available'):</strong> <span id="available_rp">{{$redeem_details['points'] ?? 0}}</span></p>
				    </div>
				    <div class="col-md-4">
				    	<p><strong>@trans('lang_v1.redeemed_amount'):</strong> (-)<span id="rp_redeemed_amount_text">{{@num_format($transaction->rp_redeemed_amount)}}</span></p>
				    </div>
			    </div>
		    ...
		    <div class="col-md-4 col-md-offset-8">
		    	...
		    	<small id="round_off"><br>(@trans('lang_v1.round_off'): <span id="round_off_text">0</span>)</small>
				<br/>
				<input type="hidden" name="round_off_amount" 
					id="round_off_amount" value=0>
				@endif
		    	<div><b>@trans('sale.total_payable'): </b>
	...
	<div class="">
		<center class="">
	    	...
	    	<button type="button" class="add_btn" id="submit-sell">@trans('messages.update')</button>
	    	<button type="button" id="save-and-print" style="widows: 220px" class="add_btn">@trans('lang_v1.update_and_print')</button>
	    </center>
	</div>
	@if(in_array('subscription', $enabled_modules))
