    ...
    <div class=" header-wrapper row m-0">
        ...
        <div class="nav-right col-8 pull-right right-header p-0">
            <ul class="nav-menus">
                    ...
                    <div class="translate_wrapper">
                        <div class="current_lang">
                            <div class="lang"><i
                                    ...
                                    class="lang-txt">{{ $languages[$user->language] }} </span></div>
                        </div>
                        <div class="more_lang">
                            ...
                            @foreach ($languages as $key => $value)
                                @if (in_array($key, ['ar', 'en']))
                                    <a class="{{ App::getLocale() == 'en' ? 'active' : '' }}" href="#"
                                        onclick="$('#selectedLang').val('{{ $key }}');$('#edit_user_profile_form')[0].submit()">
                                        <div class="lang {{ App::getLocale() == 'en' ? 'selected' : '' }}"
                                            data-value="en"><i
                                                class="flag-icon flag-icon-{{ $key == 'en' ? 'us' : $key }}"></i> <span
                                                class="lang-txt">{{ $value }}</span><span></span>
                                        </div>
                                    </a>
                                @endif
                            @endforeach
                ...
                <li class="onhover-dropdown notifications-menu">
                    @php
                    ...
                    <ul class="notification-dropdown onhover-show-div"> 
                        ...
                        @if(count($all_notifications) > 10)
                          <li class=" load_more_li">
                            <a href="#" class="btn btn-primary load_more_notifications">@trans('lang_v1.load_more')</a>
                          </li>
                        @endif 
                    </ul>
                </li>
          ...
          <ul class="chat-dropdown onhover-show-div">
            ...
            <li class="text-center"> <a class="btn btn-primary" href="#">View All     </a></li>
                ...
                <li class=" emaximize"><a class="text-whit" href="#!"
