<div class="modal-dialog modal-xl no-print" role="document">
  <div class="modal-content">
    ...
    <h4 class="modal-title" id="modalTitle"> @trans('sale.sell_details') (<b>@trans('sale.invoice_no'):</b> {{ $sell->invoice_no }})
    </h4>
</div>
<div class="modal-body">
    <div class="row">
      <div class="col-xs-12">
          <p class="pull-right"><b>@trans('messages.date'):</b> {{ @format_date($sell->transaction_date) }}</p>
      </div>
    </div>
    <div class="row">
      @php
      ...
      @if(in_array('tables' ,$enabled_modules))
         <strong>@trans('restaurant.table'):</strong>
          {{$sell->table->name ?? ''}}<br>
      @endif
      @if(in_array('service_staff' ,$enabled_modules))
          <strong>@trans('restaurant.service_staff'):</strong>
          {{$sell->service_staff->user_full_name ?? ''}}<br>
      @endif

      <strong>@trans('sale.shipping'):</strong>
      ...
      @if(!empty($sell->delivered_to))
        <br><strong>@trans('lang_v1.delivered_to'): </strong> {{$sell->delivered_to}}
      @endif
      ...
      @if(in_array('types_of_service' ,$enabled_modules))
        @if(!empty($sell->types_of_service))
          <strong>@trans('lang_v1.types_of_service'):</strong>
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-xs-12">
        <div class="table-responsive">
          @include('sub_pos.partials.sale_line_details')
        </div>
      </div>
    </div>
  ...
  <div class="modal-footer">
    <a href="#" class="print-invoice btn btn-success" data-href="{{route('sell.printInvoice', [$sell->id])}}?package_slip=true"><i class="fas fa-file-alt" aria-hidden="true"></i> @trans("lang_v1.packing_slip")</a>

    @can('print_invoice')
      <a href="#" class="print-invoice btn btn-primary" data-href="{{route('sell.printInvoice', [$sell->id])}}"><i class="fa fa-print" aria-hidden="true"></i> @trans("lang_v1.print_invoice")</a>
    @endcan
