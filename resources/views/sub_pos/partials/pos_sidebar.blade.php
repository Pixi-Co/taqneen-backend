<div class="pos-sidebar hidden" style="overflow: hidden!important" > 
    <div class="row" id="featured_products_box" style="display: none;">
        @if (!empty($featured_products))
            @include('sub_pos.partials.featured_products')
        @endif
    </div>
    <div class="w3-padding">
        <div class="row">
            ...
            <div class="col-md-4 hide" id="product_service_div">
            ...
            <div class="col-sm-4 @if (empty($featured_products)) hide @endif" id="feature_product_div">
                <button type="button" class="btn btn-primary btn-flat"
                    id="show_featured_products">@trans('lang_v1.featured_products')</button>
            </div>
        </div>
    </div>
    <br>
