<div class="row">
	<div class="col-md-12">
		<p><strong>@trans('sale.invoice_no'):</strong> {{$transaction->invoice_no}}</p>
	</div>
	<div class="col-md-4">
			...
			<div class="input-group">
				...
				<span class="input-group-btn">
					...
					@if(isset($pos_settings['enable_weighing_scale']) && $pos_settings['enable_weighing_scale'] == 1)
						...
						title="@trans('lang_v1.weighing_scale')"><i class="fa fa-digital-tachograph text-primary fa-lg"></i></button>
					@endif
