	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">@trans('lang_v1.subscribe') @if(!empty($transaction->subscription_no)) - {{$transaction->subscription_no}} @endif</h4>
			</div>
				...
				<div class="row">
				    ...
				    <div class="col-md-6">
				        <div class="form-group">
					        ...
					        <p class="help-block">@trans('lang_v1.recur_repetition_help')</p>
				        </div>
				    </div>
				    @php
				    	$repetitions = [];
