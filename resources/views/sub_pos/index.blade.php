    ...
    @component('components.widget', ['class' => 'box-primary w3-padding w3-display-container', 'title' => ''])
        @can('sell.create') 
                <div class="w3-display-topright">
                    <a class="add_btn" href="{{action('SubSellPosController@create')}}">
        ...
        @can('sell.view')
            ...
            @include('sub_pos.partials.sales_table')
        @endcan
    @endcomponent
</section>
<!-- /.content -->
...
@section('javascript')
@include('sub_pos.partials.sale_table_javascript')
