...
<div class="ticket">
	...
	@if($receipt_details->show_barcode)
		...
		<img class="center-block hidden" src="data:image/png;base64,{{DNS1D::getBarcodePNG($receipt_details->invoice_no, 'C128', 2,30,array(39, 48, 54), true)}}">
	@endif
	
	<div class="text-left">
        <br>
		@if (!empty($receipt_details->qrcode_img))
			<img style="mx-width: 120px;margin-right: 0px" src="{{ $receipt_details->qrcode_img }}"
				class="img img-responsive center-block"> 
			<br>
			<b>@trans("qrcode img of tax of invoice")</b>
		@endif
		

		@if ($receipt_details->commercial_number)
		<h3>
			@trans('commercial_number') : {{ $receipt_details->commercial_number }}
		</h3>
		@endif

		@if ($receipt_details->tax_number)
		<h3>
			@trans('tax_number') : {{ $receipt_details->tax_number }}
		</h3>
		@endif
	</div>
