...
<br>
    <h1>@trans('lang_v1.add_purchase_return')</h1>
</section>
...
<section class="content no-print">
	...
	<div class="box box-solid w3-padding">
		...
		<div class="box-body">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="text-center"><b>@trans('stock_adjustment.total_amount'):</b> <span id="total_return">0.00</span></div>
				</div>
			</div>
		</div>
	</div> <!--box end-->
	<div class="">
		<div class="text-center">
			...
			class="add_btn">@trans('messages.submit')</button>
		</div>
	</div>
	{!! Form::close() !!}
</section>
