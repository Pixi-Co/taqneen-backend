...
<br>
    <h1>@trans('lang_v1.edit_purchase_return')</h1>
</section>
...
<section class="content no-print">
		...
		<div class="box-body">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="text-center"><b>@trans('stock_adjustment.total_amount'):</b> <span id="total_return" class="display_currency">{{$purchase_return->final_total}}</span></div>
				</div>
			</div>
		</div>
	</div> <!--box end-->
	<div class="">
		<div class="text-center">
			<button type="button" id="submit_purchase_return_form" style="float: none" class="add_btn">@trans('messages.update')</button>
		</div>
	</div>
	{!! Form::close() !!}
</section>
