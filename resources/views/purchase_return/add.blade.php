...
<section class="content-header">
    <h1>@trans('lang_v1.purchase_return')</h1>
</section>
...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-primary'])
				...
				<table class="table bg-gray" id="purchase_return_table">
		          	<thead>
			            <tr class="bg-green">
			              	...
			              	<th>@trans('lang_v1.quantity_left')</th>
			            ...
			            <tr>
			              	...
			              	<td>
					            ...
					            @if($purchase_line->product->enable_stock) 
			              			...
			              			data-msg-max-value="@trans('validation.custom-messages.quantity_not_available', ['qty' => $purchase_line->formatted_qty_available, 'unit' => $unit_name ])" 
			              		@endif
					            >
		...
		<div class="row">
			<div class="col-sm-4">
				<strong>@trans('lang_v1.total_return_tax'): </strong>
