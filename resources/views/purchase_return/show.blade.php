<div class="modal-dialog modal-xl" role="document">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="modalTitle"> @trans('lang_v1.purchase_return_details') (<b>@trans('purchase.ref_no'):</b> #{{ $purchase->return_parent->ref_no ?? $purchase->ref_no}})
        </h4>
    </div>
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-6 col-xs-6">
            <h4>@trans('lang_v1.purchase_return_details'):</h4>
            <strong>@trans('lang_v1.return_date'):</strong> {{@format_date($purchase->return_parent->transaction_date)}}<br>
            <strong>@trans('purchase.supplier'):</strong> {{ $purchase->contact->name }} <br>
            <strong>@trans('purchase.business_location'):</strong> {{ $purchase->location->name }}
        </div>
        <div class="col-sm-6 col-xs-6">
            <h4>@trans('purchase.purchase_details'):</h4>
            <strong>@trans('purchase.ref_no'):</strong> {{ $purchase->ref_no }} <br>
            <strong>@trans('messages.date'):</strong> {{@format_date($purchase->transaction_date)}}
        </div>
        @else
            <div class="col-sm-6 col-xs-6">
                <h4>@trans('lang_v1.purchase_return_details'):</h4>
                <strong>@trans('lang_v1.return_date'):</strong> {{@format_date($purchase->transaction_date)}}<br>
                <strong>@trans('purchase.supplier'):</strong> {{ $purchase->contact->name ?? '' }} <br>
                <strong>@trans('purchase.business_location'):</strong> {{ $purchase->location->name }}
            </div>
        @endif
          ...
          <table class="table bg-gray">
            <thead>
              <tr class="bg-green">
                  ...
                  <th>@trans('lang_v1.return_quantity')</th>
                  <th>@trans('lang_v1.return_subtotal')</th>
              </tr>
          </thead>
          <tbody>
              @php
    ...
    <div class="row">
      <div class="col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
        <table class="table">
          ...
          <tr>
            <th>@trans('lang_v1.total_return_tax'):</th>
            <td><b>(+)</b></td>
            <td class="text-right">
          ...
          <tr>
            <th>@trans('lang_v1.return_total'):</th>
            <td></td>
    ...
    <div class="modal-footer">
      ...
      onclick="$(this).closest('div.modal-content').printThis();"><i class="fa fa-print"></i> @trans( 'messages.print' )
      </button>
