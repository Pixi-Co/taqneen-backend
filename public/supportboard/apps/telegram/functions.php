 ...
 * ==========================================================
 *
 * Telegram app main file. © 2017-2022 board.support. All rights reserved.
 *
...
function sb_telegram_synchronization($token, $cloud = '') {
    return sb_get('https://api.telegram.org/bot' . $token . '/setWebhook?url=' . SB_URL . '/apps/telegram/post.php' . str_replace(['&','='], ['%3F','%3D'], $cloud));
}
