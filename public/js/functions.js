...
function new_print_receipt(content) {
    ...
    var printWindow = window.open("", "new invoice");
...
function __print_contact_receipt(receipt_id) {
    $.get("/payments/print-pay-contact-due/" + receipt_id, function(content) {
        new_print_receipt(content);
    });
}
