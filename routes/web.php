...
>>>>>>> 5ab433393f4ce4eeb19b385ea174ac3d73e7de65
    ...
    Route::get('/business/settings-tab', 'BusinessController@settingsTab')->name('business.getBusinessSettingsTab');
    ...
    Route::get('packages/permissions/{resource}', 'BussinessTypeController@packagePermission');
    Route::post('business_types/updatePermission/{resource}', 'BussinessTypeController@updatePackagePermission');
    ...
    Route::get('/contacts/installments/{id}', 'ContactController@installments');
    ...
    Route::post('/memberships/mass-deactivate', 'MemberShipController@massDeactivate');
    Route::post('/memberships/bulk-edit', 'MemberShipController@bulkEdit');
    Route::post('/memberships/mass-delete', 'MemberShipController@massDestroy');
    ...
    Route::get('/sub/sells/convert-to-draft/{id}', 'SubSellPosController@convertToInvoice');
    Route::get('/sub/sells/convert-to-proforma/{id}', 'SubSellPosController@convertToProforma');
    Route::get('/sub/toggle-subscription/{id}', 'SubSellPosController@toggleRecurringInvoices');
    Route::get('/sub/sells/subscriptions', 'SubSellPosController@listSubscriptions');
    Route::post('/sub/sells/pos/get-types-of-service-details', 'SubSellPosController@getTypesOfServiceDetails');
    Route::get('/sub/sells/pos/get_product_row/{variation_id}/{location_id}', 'SubSellPosController@getProductRow');
    Route::post('/sub/sells/pos/get_payment_row', 'SubSellPosController@getPaymentRow');
    Route::post('/sub/sells/pos/get-reward-details', 'SubSellPosController@getRewardDetails');
    Route::get('/sub/sells/pos/get-recent-transactions', 'SellPSubSellPosControllerosController@getRecentTransactions');
    Route::get('/sub/sells/pos/get-product-suggestion', 'SubSellPosController@getProductSuggestion');
    Route::get('/sub/sells/pos/get-featured-products/{location_id}', 'SubSellPosController@getFeaturedProducts');
    Route::resource('/sub/pos', 'SubSellPosController');
    ...
    Route::get('/reports/pages/subscription-report', 'ReportController@subscriptionPage');
    ...
    Route::get('/reports/trial-balance', 'ReportController@getTrialBalance');
    ...
    Route::get('expense/simple_create', 'ExpenseController@simpleCreate');
    Route::post('expense/simple_create', 'ExpenseController@simpleStore')->name('expense.simple_create');
    ...
    Route::get('/payments/print-pay-contact-due/{id}', 'TransactionPaymentController@printContactPayment');
    ...
    Route::post('/cash-register/update-status', 'CashRegisterController@updateSafeStatusOfRegister');
    ...
    Route::get('chart-accounts', 'AccountTypeController@getChartAccountTree');
    Route::post('chart-accounts/update', 'AccountTypeController@updateChartAccount');
    Route::post('chart-accounts/store', 'AccountTypeController@storeChartAccount');
    Route::post('chart-accounts/destroy', 'AccountTypeController@destroyChartAccount');
