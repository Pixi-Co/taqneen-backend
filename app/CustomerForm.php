...
class CustomerForm extends Model
{
    ...
    public function getTagValue($tag) {  
        ...
        $resource->customer_form_pdf = "<a href='" . url('/customer-pdf-download') . "/" . $this->id . "' ><div style='border: 1px solid lightgray;text-align: center;width: 100px;border-radius: 6px;box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px;' ><img style='width: 100px;' src='".url('/images/pdf_file.jpg')."' ><br> <b>تحميل</b> </div></a><br>";
