...
class InvoiceLayoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                ...
                'qrcode_img' => 'mimes:jpeg,gif,png|1000',
            ]);

            $input = $request->only(['commercial_number', 'tax_number', 'is_subscription', 'qrcode_img', 'name', 'header_text',
            ...
            $checkboxes = ['is_subscription', 'show_business_name', 'show_location_name', 'show_landmark', 'show_city', 'show_state', 'show_country', 'show_zip_code', 'show_mobile_number', 'show_alternate_number', 'show_email', 'show_tax_1', 'show_tax_2', 'show_logo', 'show_barcode', 'show_payments', 'show_customer', 'show_client_id',
            ...
            $qrcode_img = $this->commonUtil->uploadFile($request, 'qrcode_img', 'invoice_logos', 'image');
            if (!empty($logo_name)) {
                $input['logo'] = $logo_name;
            }
            if (!empty($qrcode_img)) {
                $input['qrcode_img'] = $qrcode_img;
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('settings')->with('status', $output);
    }
