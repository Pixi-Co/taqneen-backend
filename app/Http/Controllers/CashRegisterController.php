...
class CashRegisterController extends Controller
{
    ...
    public function updateSafeStatusOfRegister() {
        $cashRegister = request()->cash_register_id;
        try {
            $resource = CashRegister::find($cashRegister);
            $resource->update([
    ...
    public function postCloseRegister(Request $request)
    {
        ...
        try {
            ...
            $input = $request->only(['for_user_id', 'safe_status', 'closing_amount', 'total_card_slips', 'total_cheques',
                                    'closing_note']);
