    ...
    public function index()
    {
        ...
        if (request()->ajax() && request()->content_type != 'html') {
            ...
            return Datatables::of($barcodes)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'BarcodeController@edit\', [$id])}}" class="btn btn-xs btn-primary edit_barcode_button"><i class="glyphicon glyphicon-edit"></i> @trans("messages.edit")</button>    
                    &nbsp;
                        <button type="button" data-href="{{action(\'BarcodeController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_barcode_button" @if($is_default) disabled @endif><i class="glyphicon glyphicon-trash"></i> @trans("messages.delete")</button>&nbsp;
                        @if($is_default)
                        ...
                        @else
                            <button class="btn btn-xs btn-info set_default" data-href="{{action(\'BarcodeController@setDefault\', [$id])}}">@trans("barcode.set_as_default")</button>
                        @endif
                        '
                )
