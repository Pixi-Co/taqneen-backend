...
<body> 
  <a href="{{ url('/') }}" style="margin: 30px">
    ...
    <div class="container">
        ...
        <div class="feedback">
          <img src="{{ url('/images/sub/trainer.png') }}" style="width: 100px;margin: auto" alt="">
          <h3>{{ $trainer->full_name }}</h3>
          <h5>{{ $trainer->class_type_names }}</h5>
      ...
      <script>
        ...
        $('.rate-btn').click(function(){
          ...
          $.post("{{ url('/sub/rate-trainer') }}/{{ $trainer->id }}?", $.param(data), function(r){
            if (r.status == 1) {
