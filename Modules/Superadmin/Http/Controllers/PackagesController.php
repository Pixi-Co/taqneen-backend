...
class PackagesController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only([
                ...
                'renew_price', 'price', 'sort_order', 'is_active', 
    ...
    public function edit($id)
    {
        ...
        return view('superadmin::packages.edit')
            ->with(compact('packages', 'intervals', 'permissions', 'permissions_pos', 'currency'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $packages_details = $request->only([
                ...
                'user_count', 'product_count', 'invoice_count', 
                'interval', 'interval_count', 'trial_days', 
                'renew_price', 'price', 'sort_order', 'is_active', 'custom_permissions', 
