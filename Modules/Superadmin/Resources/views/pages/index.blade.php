...
<section class="content-header">
    <h1>@trans('superadmin::lang.frontend_pages')</h1>
</section>
	                ...
	                <div class="col-md-4 page_details">
						<div class="box box-success hvr-grow-shadow">
								...
								<div class="row">
									@if($page->is_shown == 1)
										<span class="badge bg-green">
											@trans('superadmin::lang.visible')
										</span>
									@else
										<span class="badge bg-red">
										@trans('superadmin::lang.hidden')
										</span>
									@endif

                                    <span class="badge bg-info" title="@trans('superadmin::lang.menu_order')">
                                        {{$page->menu_order}}
                                    </span>
							...
							<div class="box-body" style="max-height: 300px; overflow: hidden;">
								<strong>@trans('superadmin::lang.page_content'):</strong>
								{!! $page->content !!}
							</div>
						</div>
						<!-- /.box -->
