    ...
    <div class="modal-content">
     {!! Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController@update',$subscription->id), 'method' => 'PUT', 'id' => 'status_change_form']) !!}
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">@trans( "superadmin::lang.subscription_status")</h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary">@trans( "superadmin::lang.update")</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">@trans( "superadmin::lang.close")</button>
      </div>
      {!! Form::close() !!}
    </div>
</div>
