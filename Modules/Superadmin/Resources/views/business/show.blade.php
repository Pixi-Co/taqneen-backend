...
<section class="content-header">
    <h1>@trans( 'superadmin::lang.view_business' )
...
<section class="content">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="well well-sm">
                            ...
                            @trans('business.currency')</strong>
                            <p class="text-muted">
                                {{ $business->currency->currency }}
                            </p>

                            <strong><i class="fa fa-file-text-o margin-r-5"></i> 
                            @trans('business.tax_number1')</strong>
                            <p class="text-muted">
                            ...
                            <strong><i class="fa fa-file-text-o margin-r-5"></i> 
                            @trans('business.tax_number2')</strong>
                            <p class="text-muted">
                    ...
                    <div class="col-sm-3">
                        <div class="well well-sm">
                            ...
                            @trans('business.time_zone')</strong>
                            <p class="text-muted">
                            {{ $business->time_zone }}
                            </p>

                            <strong><i class="fa fa-toggle-on margin-r-5"></i> 
                            @trans('business.is_active')</strong>
                            ...
                            @trans('business.created_by')</strong>
                            @if(!empty($created_by))
                            <p class="text-muted">
    ...
    <div class="box">
        <div class="box-header">
                <h3 class="box-title">
                    <strong><i class="fa fa-map-marker margin-r-5"></i> 
                    @trans( 'superadmin::lang.business_location' )</strong>
                </h3>
        </div>
        <div class="box-body">
                <div class="row">
    ...
    <div class="box">
        <div class="box-header">
                <h3 class="box-title">
                    ...
                    @trans( 'superadmin::lang.package_subscription' )</strong>
                </h3>
        </div>
        <div class="box-body">
                <div class="row">
