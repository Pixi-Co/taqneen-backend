...
<section class="content-header">
    <h1>@trans( 'superadmin::lang.all_business' )
        <small>@trans( 'superadmin::lang.manage_business' )</small>
    </h1>
    <!-- <ol class="breadcrumb">
        ...
        <div class="box-body">
            @can('superadmin')
                <div class="table-responsive w3-light-gray">
                    <table data-title="@trans('superadmin::lang.all_business')" class="table table-bordered table-striped" id="superadmin_business_table">
                        <thead>
                            <tr>
                                <th>@trans( 'superadmin::lang.business_name' )</th>
                                <th>@trans('business.owner')</th>
                                <th>@trans('business.email')</th>
                                <th>@trans('superadmin::lang.owner_number')</th>
                                <th>@trans( 'superadmin::lang.business_contact_number' )</th>
                                <th>@trans('business.address')</th>
                                <th>@trans( 'sale.status' )</th>
                                <th>@trans( 'superadmin::lang.current_subscription' )</th>
