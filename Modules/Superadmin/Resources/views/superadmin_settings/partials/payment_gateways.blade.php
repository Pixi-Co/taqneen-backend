    ...
    <div class="row">
        <div class="col-xs-6">
            <div class="form-group">
                ...
                [ 'class' => 'input-icheck']); !!}
                @trans('superadmin::lang.enable_offline_payment')
                </label>
            </div>
        </div>
        <div class="col-xs-6">
        ...
        <div class="col-xs-12 mt-0">
            <p class="help-block mt-0">
                <a href="https://support.flutterwave.com/en/articles/3632719-accepted-currencies" target="_blank">
                    @trans('superadmin::lang.flutterwave_help_text')
                </a>
            </p>
        </div>
        <div class="col-xs-12">
            <br/>
            <p class="help-block"><i>@trans('superadmin::lang.payment_gateway_help')</i></p>
        </div>
    </div>
</div>