    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                [ 'class' => 'input-icheck']); !!}
                @trans('superadmin::lang.allow_email_settings_to_businesses') 
                </label>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                [ 'class' => 'input-icheck']); !!}
                @trans('superadmin::lang.enable_new_business_registration_notification') 
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                [ 'class' => 'input-icheck']); !!}
                @trans('superadmin::lang.enable_new_subscription_notification') 
        ...
        <div class="col-xs-12">
            <h4>@trans('superadmin::lang.welcome_email_template'):</h4>
            <strong>@trans('lang_v1.available_tags'):</strong> {business_name}, {owner_name} <br><br>
        </div>
        <div class="col-xs-12">
            <div class="form-group">
