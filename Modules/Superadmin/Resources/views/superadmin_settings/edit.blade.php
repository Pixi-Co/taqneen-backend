...
<section class="content-header">
    <h1>@trans('superadmin::lang.super_admin_settings')<small>@trans('superadmin::lang.edit_super_admin_settings')</small></h1>
    <!-- <ol class="breadcrumb">
            ...
            <div class="col-xs-12 pos-tab-container">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                    <div class="list-group">
                        <a href="#" class="list-group-item text-center active">@trans('superadmin::lang.super_admin_settings')</a>
                        <a href="#" class="list-group-item text-center">@trans('superadmin::lang.application_settings')</a>
                        <a href="#" class="list-group-item text-center">@trans('superadmin::lang.email_smtp_settings')</a>
                        <a href="#" class="list-group-item text-center">@trans('superadmin::lang.payment_gateways')</a>
                        <a href="#" class="list-group-item text-center">@trans('superadmin::lang.backup')</a>
                        <a href="#" class="list-group-item text-center">@trans('superadmin::lang.cron')</a>
                        <a href="#" class="list-group-item text-center">@trans('superadmin::lang.pusher_settings')</a>
                        <a href="#" class="list-group-item text-center">@trans('superadmin::lang.additional_js_css')</a>
                    </div>
                </div>
