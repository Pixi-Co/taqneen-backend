      ...
      <div class="row">
        <div class="col-xs-6">
          <div class="well well-sm">
            <strong>@trans('business.business_name'): </strong> {{$system["invoice_business_name"]}} <br>
            <strong>@trans('business.email'): </strong> {{$system["email"]}} <br>
            <strong>@trans('business.landmark'): </strong> {{$system["invoice_business_landmark"]}} <br>
            <strong>@trans('business.city'): </strong> {{$system["invoice_business_city"]}}
            <strong>@trans('business.zip_code'): </strong> {{$system["invoice_business_zip"]}} <br>
            <strong>@trans('business.state'): </strong> {{$system["invoice_business_state"]}}
            <strong>@trans('business.country'): </strong> {{$system["invoice_business_country"]}}
          </div>
        </div>
        <div class="col-xs-6">
          <div class="well well-sm">
            <strong>@trans('business.business_name'): </strong> {{$subscription->business->name}} <br>
