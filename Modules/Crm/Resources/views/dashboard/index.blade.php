		...
		@if( $contact->type == 'supplier' || $contact->type == 'both')
	    	<div class="col-md-3 col-sm-6 col-xs-12 col-custom">
		      <div class="info-box info-box-new-style">
		        ...
		        <div class="info-box-content">
		          <span class="info-box-text fs-10">@trans('report.total_purchase')</span>
		    ...
		    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
		      <div class="info-box info-box-new-style">
		        ...
		        <div class="info-box-content">
		          <span class="info-box-text fs-10">@trans('contact.total_purchase_paid')</span>
		          <span class="info-box-number display_currency" data-currency_symbol="true">
		    ...
		    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
		      <div class="info-box info-box-new-style">
		        ...
		        <div class="info-box-content">
		          <span class="info-box-text fs-10">@trans('contact.total_purchase_due')</span>
		          <span class="info-box-number display_currency" data-currency_symbol="true">
	    ...
	    @if( $contact->type == 'customer' || $contact->type == 'both')
		    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
		      <div class="info-box info-box-new-style">
		        ...
		        <div class="info-box-content">
		          <span class="info-box-text fs-10">@trans('report.total_sell')</span>
		          <span class="info-box-number display_currency" data-currency_symbol="true">
        ...
        @if(!empty($contact->opening_balance) && $contact->opening_balance != '0.00')
	        ...
	        <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
	          <div class="info-box info-box-new-style">
	            ...
	            <div class="info-box-content">
	              <span class="info-box-text fs-10">
	                @trans('lang_v1.opening_balance_due')
	              </span>
	              <span class="info-box-number display_currency" data-currency_symbol="true">
