...
<section class="content-header">
   <h1>@trans('lang_v1.my_profile')</h1>
</section>
<!-- Main content -->
		    ...
		    <div class="col-sm-12">
		        <div class="box box-solid"> <!--business info box start-->
		            <div class="box-header">
		                <div class="box-header">
		                    <h3 class="box-title"> @trans('user.change_password')</h3>
		                </div>
		            </div>
		            <div class="box-body">
		...
		<div class="row">
		    <div class="col-sm-8">
		        <div class="box box-solid"> <!--business info box start-->
		            <div class="box-header">
		                <div class="box-header">
		                    <h3 class="box-title"> @trans('user.edit_profile')</h3>
		                </div>
		            </div>
		            <!-- user id -->
		        ...
		        @component('components.widget', ['title' => __('lang_v1.profile_photo')])
		            ...
		            <div class="col-md-12">
		                <div class="form-group">
		                    ...
		                    <small><p class="help-block">@trans('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])</p></small>
		                </div>
		            </div>
		        @endcomponent
		    </div>
