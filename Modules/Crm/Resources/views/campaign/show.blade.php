<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-6">
                    <b>@trans('crm::lang.campaign_type'):</b>
            ...
            @if($campaign->campaign_type == 'email')
                <div class="row mt-5">
                    <div class="col-sm-12">
                        <b>@trans('crm::lang.subject'):</b> {{$campaign->subject}}
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-sm-12">
                        <b>@trans('crm::lang.email_body'):</b>
                        {!! $campaign->email_body !!}
                    </div>
                </div>
            ...
            @if(!empty($campaign->additional_info['to']) && $campaign->additional_info['to'] == 'transaction_activity')
                <div class="row">
                    <div class="col-md-6">
                        <b>@trans('crm::lang.transaction_activity'):</b>
                        @trans('crm::lang.'.$campaign->additional_info['trans_activity'])
                    </div>
                    <div class="col-md-6">
                        <b>@trans('crm::lang.in_days'):</b>
            ...
            <div class="row mt-5">
                @if(!empty($customers))
                    <div class="col-sm-12">
                        <strong>@trans('lang_v1.customers'): </strong>
                        <p>
                            {{implode(', ', $customers)}}
                        </p>
                    </div>
                ...
                @if(!empty($leads))
                    <div class="col-sm-12">
                        <strong>@trans('crm::lang.leads'): </strong>
                        <p>
                            {{implode(', ', $leads)}}
                        </p>
                    </div>
        ...
        <div class="modal-footer">
            <span class="pull-left">
                ...
                @trans('crm::lang.created_this_campaign_on', [
