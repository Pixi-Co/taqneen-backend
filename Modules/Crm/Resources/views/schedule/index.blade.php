...
@section('content')
	...
	<section class="content-header no-print">
	   <h1>@trans('crm::lang.follow_ups')</h1>
	</section>
				...
				@component('components.widget', ['class' => 'box box-solid', 'title' => __('crm::lang.all_schedules')])
					@slot('tool')
			            <div class="box-tools">
			                ...
			                <i class="fa fa-plus"></i> @trans('crm::lang.add_advance_follow_up')</a>
			            </div>
			            	...
			            	<table class="table table-bordered table-striped" id="follow_up_table" style="width: 100%">
						        <thead>
						            <tr>
						                ...
						                <th>
						                	@trans('lang_v1.added_by')
						                </th>
						                <th>
						                	@trans('lang_v1.added_on')
						                </th>
						            </tr>
						        </thead>
						        <tbody></tbody>
