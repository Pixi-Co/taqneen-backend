...
@section('content')
	...
	<section class="content-header no-print">
	   <h1>@trans('crm::lang.add_schedule')</h1>
	</section>
        	...
        	<div class="box-body">
        		<div class="row">
		               ...
		               <div class="form-group">
		                    ...
		                    <select class="form-control" id="follow_up_by">
		                    		<option value="">@trans('messages.please_select')</option>
								  	<optgroup label="@trans('sale.payment_status')">
								    	<option value="all" data-category="payment_status">@trans('lang_v1.all')</option>
								    	<option value="due" data-category="payment_status">@trans('lang_v1.due')</option>
								    	<option value="partial" data-category="payment_status">@trans('lang_v1.partial')</option>
								    	<option value="overdue" data-category="payment_status">@trans('lang_v1.overdue')</option>
								  	</optgroup>
								  	<optgroup label="@trans('restaurant.orders')">
								    	<option value="has_transactions" data-category="orders">
								    		@trans('crm::lang.has_transactions')
								    	</option>
								    	<option value="has_no_transactions" data-category="orders">
								    		@trans('crm::lang.has_no_transactions')
								    	</option>
								  	</optgroup>
							</select>
		               	...
		               	<div class="form-group">
		                    ...
		                    <div class="input-group">
		                        <div class="input-group-addon">{{__('crm::lang.in')}}</div>
		                            <input type="text" class="form-control input_number" id="in_days" placeholder="@trans('crm::lang.enter_days')" name="in_days" required>
		            ...
		            <div class="col-md-2 hide follow_up_by_order_field" >
		               <div class="form-group">
		               		<br>
		               		<button type="button" class="btn btn-primary" id="group_customers">@trans('pagination.next')</button>
		               </div>
		            </div>
		            ...
		            <div class="col-md-2 hide follow_up_by_payment_field" >
		               <div class="form-group">
		               		<br>
		               		<button type="button" class="btn btn-primary" id="group_invoices">@trans('pagination.next')</button>
		               </div>
		            </div>
        		</div>
        	</div>
		            ...
		            <div class="col-md-6">
		                <div class="form-group">
		                    ...
		                    <label>
		                        ...
		                        @trans('crm::lang.send_notification')
		                    </label>
		        ...
		        <div class="row">
		        	<div class="col-md-12">
		                ...
		                <small class="pull-right text-muted mt-5 mr-8">
		        			@trans('crm::lang.multiple_followups_will_be_created')
		        		</small>
		            </div>
		        </div>
		    </div>
