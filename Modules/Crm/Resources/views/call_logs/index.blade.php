        ...
        <table class="table table-bordered table-striped" id="call_logs_table" style="width: 100%;">
            <thead>
                <tr>
                    ...
                    @endif
                    <th>@trans('restaurant.start_time')</th>
                    <th>@trans('restaurant.end_time')</th>
                    <th>@trans('crm::lang.call_duration')</th>
                    <th>@trans('crm::lang.call_type')</th>
                    <th>@trans('lang_v1.contact_no')</th>
                    <th>@trans('report.contact')</th>
                    <th>@trans('role.user')</th>
                    <th>@trans('crm::lang.call_log_created_by')</th>
                </tr>
            </thead>
            @if($is_admin)
            <tfoot>
