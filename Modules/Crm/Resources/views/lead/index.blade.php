        	...
        	<table class="table table-bordered table-striped" id="leads_table">
		        <thead>
		            <tr>
                        ...
                        <th>@trans('crm::lang.source')</th>
                        <th style="width: 200px !important">
                            @trans('crm::lang.last_follow_up')
                        </th>
                        <th style="width: 200px !important">
                            @trans('crm::lang.upcoming_follow_up')
                        </th>
                        <th style="width: 200px !important">
                            @trans('crm::lang.last_followed_up_on')
                        </th>
                        <th>@trans('crm::lang.life_stage')</th>
