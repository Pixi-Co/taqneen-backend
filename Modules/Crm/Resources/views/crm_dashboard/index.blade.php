                ...
                <div class="box-body p-10">
                    <table class="table no-margin">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="2" class="text-center">@trans('lang_v1.no_data')</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <div class="col-md-6">
            <div class="box box-solid">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">@trans('crm::lang.birthdays')</h3>
                    <a data-href="{{action('\Modules\Crm\Http\Controllers\CampaignController@create')}}" class="btn btn-success btn-xs" id="wish_birthday">
                        ...
                        @trans('crm::lang.send_wishes')
                    </a>
                </div>
                <div class="box-body p-10">
                    <table class="table no-margin table-striped">
                        <caption>@trans('home.today')</caption>
                        <thead>
                            <tr>
                                <th>#</th>
                    ...
                    <table class="table no-margin table-striped">
                        <caption>
                            @trans('crm::lang.upcoming')
                        </caption>
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>@trans('user.name')</th>
                                <th>@trans('crm::lang.birthday_on')</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center">@trans('lang_v1.no_data')</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
