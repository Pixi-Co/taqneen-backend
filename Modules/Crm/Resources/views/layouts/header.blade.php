...
<header class="main-header no-print">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <button id="btnCalculator" title="@trans('lang_v1.calculator')" type="button" class="btn btn-success btn-flat pull-left m-8 hidden-xs btn-sm mt-10 popover-default" data-toggle="popover" data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true" data-placement="bottom">
                <strong>
